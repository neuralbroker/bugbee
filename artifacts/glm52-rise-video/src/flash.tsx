...
// stats.bugbee.ai design tokens (light theme)
const c = {
  bg: "#ffffff",
  ink: "#161616",
  muted: "#5c5c5c",
...
// verified: Bugbee Go, week of Jun 22-28, 2026 (2026-W26). share = % of 19.64T total Go tokens.
const bars = [
    ...
    <AbsoluteFill style={{ background: c.bg, color: c.ink, fontFamily: MONO, padding: 72, boxSizing: "border-box" }}>
      <div style={{ height: "100%", display: "flex", flexDirection: "column" }}>
        ...
        >
          ...
          <div style={{ color: c.ink }}>bugbee.dev/data</div>
        </div>
      </div>
    </AbsoluteFill>
  )
