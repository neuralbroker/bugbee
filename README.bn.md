...
# Package managers
npm i -g bugbee-ai@latest        # or bun/pnpm/yarn
scoop install bugbee             # Windows
choco install bugbee             # Windows
brew install neuralbroker/tap/bugbee # macOS and Linux (recommended, always up to date)
brew install bugbee              # macOS and Linux (official brew formula, updated less)
sudo pacman -S bugbee            # Arch Linux (Stable)
paru -S bugbee-bin               # Arch Linux (Latest from AUR)
mise use -g bugbee               # Any OS
nix run nixpkgs#bugbee           # or github:neuralbroker/bugbee for latest dev branch
```
...
Bugbee ডেস্কটপ অ্যাপ্লিকেশন হিসেবেও উপলব্ধ। সরাসরি [রিলিজ পেজ](https://github.com/neuralbroker/bugbee/releases) অথবা [bugbee.dev/download](https://github.com/neuralbroker/bugbee/download) থেকে ডাউনলোড করুন।
...
1. `$BUGBEE_INSTALL_DIR` - কাস্টম ইনস্টলেশন ডিরেক্টরি
...
4. `$HOME/.bugbee/bin` - ডিফল্ট ফলব্যাক
...
Bugbee এ দুটি বিল্ট-ইন এজেন্ট রয়েছে যা আপনি `Tab` কি(key) দিয়ে পরিবর্তন করতে পারবেন।
...
এজেন্টদের সম্পর্কে আরও জানুন: [docs](https://github.com/neuralbroker/bugbee/docs/agents)।

### ডকুমেন্টেশন (Documentation)

কিভাবে Bugbee কনফিগার করবেন সে সম্পর্কে আরও তথ্যের জন্য, [**আমাদের ডকস দেখুন**](https://github.com/neuralbroker/bugbee/docs)।

### অবদান (Contributing)

আপনি যদি Bugbee এ অবদান রাখতে চান, অনুগ্রহ করে একটি পুল রিকোয়েস্ট সাবমিট করার আগে আমাদের [কন্ট্রিবিউটিং ডকস](./CONTRIBUTING.md) পড়ে নিন।

### Bugbee এর উপর বিল্ডিং (Building on Bugbee)

আপনি যদি এমন প্রজেক্টে কাজ করেন যা Bugbee এর সাথে সম্পর্কিত এবং প্রজেক্টের নামের অংশ হিসেবে "bugbee" ব্যবহার করেন, উদাহরণস্বরূপ "bugbee-dashboard" বা "bugbee-mobile", তবে দয়া করে আপনার README তে একটি নোট যোগ করে স্পষ্ট করুন যে এই প্রজেক্টটি Bugbee দল দ্বারা তৈরি হয়নি এবং আমাদের সাথে এর কোনো সরাসরি সম্পর্ক নেই।

---

**আমাদের কমিউনিটিতে যুক্ত হোন** [Discord](https://discord.gg/bugbee) | [X.com](https://x.com/bugbee)
