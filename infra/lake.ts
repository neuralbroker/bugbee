...
const tableBucketName = `bugbee-${$app.stage}-lake`
...
const firehose = new aws.kinesis.FirehoseDeliveryStream(
  "LakeFirehose",
  {
    name: `bugbee-${$app.stage}-lake-ingest`,
    destination: "iceberg",
