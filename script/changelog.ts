...
Generates UPCOMING_CHANGELOG.md by running the bugbee changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for bugbee run (default: low)
      --quiet            Suppress bugbee command output unless it fails
