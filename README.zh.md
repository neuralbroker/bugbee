...
brew install neuralbroker/tap/bugbee # macOS 和 Linux（推荐，始终保持最新）
brew install bugbee              # macOS 和 Linux（官方 brew formula，更新频率较低）
sudo pacman -S bugbee            # Arch Linux (Stable)
paru -S bugbee-bin               # Arch Linux (Latest from AUR)
mise use -g bugbee               # 任意系统
nix run nixpkgs#bugbee           # 或用 github:neuralbroker/bugbee 获取最新 dev 分支
```
...
Bugbee 也提供桌面版应用。可直接从 [发布页 (releases page)](https://github.com/neuralbroker/bugbee/releases) 或 [bugbee.dev/download](https://github.com/neuralbroker/bugbee/download) 下载。
...
1. `$BUGBEE_INSTALL_DIR` - 自定义安装目录
2. `$XDG_BIN_DIR` - 符合 XDG 基础目录规范的路径
3. `$HOME/bin` - 如果存在或可创建的用户二进制目录
4. `$HOME/.bugbee/bin` - 默认备用路径
...
Bugbee 内置两种 Agent，可用 `Tab` 键快速切换：
...
了解更多 [Agents](https://github.com/neuralbroker/bugbee/docs/agents) 相关信息。

### 文档

更多配置说明请查看我们的 [**官方文档**](https://github.com/neuralbroker/bugbee/docs)。
...
如果你在项目名中使用了 “bugbee”（如 “bugbee-dashboard” 或 “bugbee-mobile”），请在 README 里注明该项目不是 Bugbee 团队官方开发，且不存在隶属关系。

---

**加入我们的社区** [飞书](https://applink.feishu.cn/client/chat/chatter/add_by_link?link_token=52ao9352-5623-4fa0-b7dd-3407c392c1af&qr_code=true) | [X.com](https://x.com/bugbee)
