...
npm i -g bugbee-ai@latest        # o bun/pnpm/yarn
scoop install bugbee             # Windows
choco install bugbee             # Windows
brew install neuralbroker/tap/bugbee # macOS y Linux (recomendado, siempre al día)
brew install bugbee              # macOS y Linux (fórmula oficial de brew, se actualiza menos)
sudo pacman -S bugbee            # Arch Linux (Stable)
paru -S bugbee-bin               # Arch Linux (Latest from AUR)
mise use -g bugbee               # cualquier sistema
nix run nixpkgs#bugbee           # o github:neuralbroker/bugbee para la rama dev más reciente
```
...
Bugbee también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/neuralbroker/bugbee/releases) o desde [bugbee.dev/download](https://github.com/neuralbroker/bugbee/download).
...
1. `$BUGBEE_INSTALL_DIR` - Directorio de instalación personalizado
2. `$XDG_BIN_DIR` - Ruta compatible con la especificación XDG Base Directory
3. `$HOME/bin` - Directorio binario estándar del usuario (si existe o se puede crear)
4. `$HOME/.bugbee/bin` - Alternativa por defecto
...
Bugbee incluye dos agentes integrados que puedes alternar con la tecla `Tab`.
...
Más información sobre [agentes](https://github.com/neuralbroker/bugbee/docs/agents).

### Documentación

Para más información sobre cómo configurar Bugbee, [**ve a nuestra documentación**](https://github.com/neuralbroker/bugbee/docs).

### Contribuir

Si te interesa contribuir a Bugbee, lee nuestras [docs de contribución](./CONTRIBUTING.md) antes de enviar un pull request.

### Proyectos basados en Bugbee

Si estás trabajando en un proyecto basado en Bugbee y usas "bugbee" como parte del nombre, por ejemplo, "bugbee-dashboard" u "bugbee-mobile", agrega una nota en tu README para aclarar que no está hecho por el equipo de Bugbee y que no está afiliado con nosotros de ninguna manera.

---

**Únete a nuestra comunidad** [Discord](https://discord.gg/bugbee) | [X.com](https://x.com/bugbee)
