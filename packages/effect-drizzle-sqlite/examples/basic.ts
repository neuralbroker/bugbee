...
class Database extends Context.Service<Database, DatabaseShape>()("@bugbee/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@bugbee/example/UserStore") {
