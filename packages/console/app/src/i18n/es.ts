...
export const dict = {
  ...
  "notFound.title": "No encontrado | bugbee",
  "notFound.heading": "404 - Página no encontrada",
  "notFound.home": "Inicio",
  "notFound.docs": "Documentación",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "bugbee logo claro",
  "notFound.logoDarkAlt": "bugbee logo oscuro",
  ...
  "app.meta.description": "Bugbee - El agente de codificación de código abierto.",

  "home.title": "Bugbee | El agente de codificación IA de código abierto",

  "temp.title": "bugbee | Agente de codificación IA creado para la terminal",
  ...
  "temp.feature.zen.afterLink": "proporcionada por bugbee",
  ...
  "temp.screenshot.caption": "bugbee TUI con el tema tokyonight",
  "temp.screenshot.alt": "bugbee TUI con tema tokyonight",
  "temp.logoLightAlt": "logo de bugbee claro",
  "temp.logoDarkAlt": "logo de bugbee oscuro",
  ...
  "home.what.title": "¿Qué es Bugbee?",
  "home.what.body":
    "Bugbee es un agente de código abierto que te ayuda a escribir código en tu terminal, IDE o escritorio.",
  ...
  "home.growth.body":
    "Con más de <strong>{{stars}}</strong> estrellas en GitHub, <strong>{{contributors}}</strong> colaboradores y más de <strong>{{commits}}</strong> commits, Bugbee es usado y confiado por más de <strong>{{monthlyUsers}}</strong> desarrolladores cada mes.",
  ...
  "home.privacy.body":
    "Bugbee no almacena tu código ni datos de contexto, para que pueda operar en entornos sensibles a la privacidad.",
  "home.privacy.learnMore": "Más información sobre",
  "home.privacy.link": "privacidad",

  "home.faq.q1": "¿Qué es Bugbee?",
  "home.faq.a1":
    "Bugbee es un agente de código abierto que te ayuda a escribir y ejecutar código con cualquier modelo de IA. Está disponible como interfaz de terminal, aplicación de escritorio o extensión de IDE.",
  "home.faq.q2": "¿Cómo uso Bugbee?",
  "home.faq.a2.before": "La forma más fácil de empezar es leer la",
  "home.faq.a2.link": "introducción",
  "home.faq.q3": "¿Necesito suscripciones extra de IA para usar Bugbee?",
  "home.faq.a3.p1":
    "No necesariamente, Bugbee viene con un conjunto de modelos gratuitos que puedes usar sin crear una cuenta.",
  ...
  "home.faq.a3.p3":
    "Aunque animamos a los usuarios a usar Zen, Bugbee también funciona con todos los proveedores populares como OpenAI, Anthropic, xAI, etc.",
  "home.faq.a3.p4.beforeLocal": "Incluso puedes conectar tus",
  "home.faq.a3.p4.localLink": "modelos locales",
  "home.faq.q4": "¿Puedo usar mis suscripciones de IA existentes con Bugbee?",
  "home.faq.a4.p1":
    "Sí, Bugbee soporta planes de suscripción de los principales proveedores. Puedes usar tus suscripciones de Claude Pro/Max, ChatGPT Plus/Pro o GitHub Copilot.",
  "home.faq.q5": "¿Solo puedo usar Bugbee en la terminal?",
  "home.faq.a5.beforeDesktop": "¡Ya no! Bugbee ahora está disponible como una aplicación para tu",
  "home.faq.a5.desktop": "escritorio",
  "home.faq.a5.and": "y",
  "home.faq.a5.web": "web",
  "home.faq.q6": "¿Cuánto cuesta Bugbee?",
  "home.faq.a6":
    "Bugbee es 100% gratuito de usar. También viene con un conjunto de modelos gratuitos. Puede haber costos adicionales si conectas cualquier otro proveedor.",
  ...
  "home.faq.q8": "¿Es Bugbee de código abierto?",
  "home.faq.a8.p1": "Sí, Bugbee es totalmente de código abierto. El código fuente es público en",
  ...
  "home.zenCta.body":
    "Zen te da acceso a un conjunto seleccionado de modelos de IA que Bugbee ha probado y evaluado específicamente para agentes de codificación. No necesitas preocuparte por el rendimiento y la calidad inconsistentes entre proveedores, usa modelos validados que funcionan.",
  "home.zenCta.link": "Aprende sobre Zen",

  "zen.title":
    "Bugbee Zen | Un conjunto seleccionado de modelos optimizados y confiables para agentes de codificación",
  "zen.hero.title": "Modelos optimizados y confiables para agentes de codificación",
  "zen.hero.body":
    "Zen te da acceso a un conjunto seleccionado de modelos de IA que Bugbee ha probado y evaluado específicamente para agentes de codificación. No necesitas preocuparte por el rendimiento y la calidad inconsistentes, usa modelos validados que funcionan.",

  "zen.faq.q1": "¿Qué es Bugbee Zen?",
  "zen.faq.a1":
    "Zen es un conjunto seleccionado de modelos de IA probados y evaluados para agentes de codificación, creado por el equipo detrás de Bugbee.",
  ...
  "zen.faq.a3":
    "Zen no tiene fines de lucro. Zen te transfiere los costos de los proveedores de modelos. Cuanto mayor sea el uso de Zen, más podrá Bugbee negociar mejores tarifas y transferírtelas.",
  ...
  "zen.faq.a4.p3":
    "Para cubrir costos, Bugbee añade solo una pequeña tarifa de procesamiento de pagos de $1.23 por cada recarga de saldo de $20.",
  ...
  "zen.faq.a8":
    "Aunque Zen funciona genial con Bugbee, puedes usar Zen con cualquier agente. Sigue las instrucciones de configuración en tu agente de codificación preferido.",
  ...
  "zen.problem.subtitle": "Estamos arreglando esto para todos, no solo para usuarios de Bugbee.",
  ...
  "zen.how.body": "Aunque sugerimos usar Zen con Bugbee, puedes usar Zen con cualquier agente.",
  ...
  "go.title": "Bugbee Go | Modelos de programación de bajo coste para todos",
  ...
  "go.problem.body":
    "Nos enfocamos en llevar la experiencia de Bugbee a tantas personas como sea posible. Bugbee Go es una suscripción de bajo coste: $5 el primer mes, luego 10 $/mes. Proporciona límites generosos y acceso fiable a los modelos de código abierto más capaces.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go comienza en $5 el primer mes, luego 10 $/mes. Puedes usarlo con Bugbee o cualquier agente.",
  ...
  "zen.api.error.trialEnded":
    "La promoción gratuita de {{model}} ha finalizado. Puedes seguir usando el modelo suscribiéndote a Bugbee Go - {{link}}",

  "black.meta.title": "Bugbee Black | Accede a los mejores modelos de codificación del mundo",
  "black.meta.description": "Obtén acceso a Claude, GPT, Gemini y más con los planes de suscripción de Bugbee Black.",
  ...
  "black.title": "Bugbee Black | Precios",
  ...
  "black.subscribe.success.title": "Estás en la lista de espera de Bugbee Black",
  "black.subscribe.success.subscriptionPlan": "Plan de suscripción",
  "black.subscribe.success.planName": "Bugbee Black {{plan}}",
  ...
  "workspace.newUser.feature.lockin.body":
    "Usa Zen con cualquier agente de codificación, y continúa usando otros proveedores con bugbee cuando quieras.",
  ...
  "workspace.newUser.step.login.after": "y selecciona bugbee",
  "workspace.newUser.step.pasteKey": "Pega tu clave API",
  "workspace.newUser.step.models.before": "Inicia bugbee y ejecuta",
  ...
  "workspace.keys.subtitle": "Gestiona tus claves API para acceder a los servicios de bugbee.",
  "workspace.keys.create": "Crear Clave API",
  "workspace.keys.placeholder": "Introduce nombre de la clave",
  "workspace.keys.empty": "Crea una clave API de bugbee Gateway",
  ...
  "workspace.black.subscription.message": "Estás suscrito a Bugbee Black por ${{plan}} al mes.",
  ...
  "workspace.black.waitlist.joined": "Estás en la lista de espera para el plan Bugbee Black de ${{plan}} al mes.",
  "workspace.black.waitlist.ready": "Estamos listos para inscribirte en el plan Bugbee Black de ${{plan}} al mes.",
  ...
  "workspace.lite.subscription.message": "Estás suscrito a Bugbee Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Selecciona "Bugbee Go" como proveedor en tu configuración de bugbee para usar los modelos Go.',
  ...
  "workspace.lite.black.message":
    "Actualmente estás suscrito a Bugbee Black o estás en la lista de espera. Por favor, cancela la suscripción primero si deseas cambiar a Go.",
  "workspace.lite.other.message":
    "Otro miembro de este espacio de trabajo ya está suscrito a Bugbee Go. Solo un miembro por espacio de trabajo puede suscribirse.",
  "workspace.lite.promo.description":
    "Bugbee Go comienza en {{price}}, luego $10/mes, y ofrece acceso confiable a modelos de codificación abiertos populares con límites de uso generosos.",
  ...
  "download.title": "Bugbee | Descargar",
  "download.meta.description": "Descarga Bugbee para macOS, Windows y Linux",
  "download.hero.title": "Descargar Bugbee Desktop",
  "download.hero.subtitle": "Disponible en Beta para macOS, Windows y Linux",
  "download.hero.button": "Descargar para {{os}}",
  "download.section.terminal": "Bugbee Terminal",
  "download.section.desktop": "Bugbee Desktop",
  "download.section.extensions": "Extensiones Bugbee",
  "download.section.integrations": "Integraciones Bugbee",
  ...
  "download.faq.a3.beforeLocal":
    "No necesariamente, pero probablemente. Necesitarás una suscripción de IA si quieres conectar Bugbee a un proveedor de pago, aunque puedes trabajar con",
  ...
  "download.faq.a3.afterZen":
    ", Bugbee funciona con todos los proveedores populares como OpenAI, Anthropic, xAI, etc.",

  "download.faq.a5.p1": "Bugbee es 100% gratuito de usar.",
  "download.faq.a5.p2.beforeZen":
    "Cualquier costo adicional vendrá de tu suscripción a un proveedor de modelos. Aunque Bugbee funciona con cualquier proveedor de modelos, recomendamos usar",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Tus datos e información solo se almacenan cuando creas enlaces compartibles en Bugbee.",
  "download.faq.a6.p2.beforeShare": "Más información sobre",
  "download.faq.a6.shareLink": "páginas compartidas",

  "enterprise.title": "Bugbee | Soluciones empresariales para tu organización",
  "enterprise.meta.description": "Contacta a Bugbee para soluciones empresariales",
  "enterprise.hero.title": "Tu código es tuyo",
  "enterprise.hero.body1":
    "Bugbee opera de forma segura dentro de tu organización sin almacenar datos ni contexto, y sin restricciones de licencia ni reclamaciones de propiedad. Inicia una prueba con tu equipo, luego despliégalo en toda tu organización integrándolo con tu SSO y pasarela de IA interna.",
  ...
  "enterprise.faq.q1": "¿Qué es Bugbee Enterprise?",
  "enterprise.faq.a1":
    "Bugbee Enterprise es para organizaciones que quieren asegurar que su código y datos nunca salgan de su infraestructura. Puede hacer esto usando una configuración centralizada que se integra con tu SSO y pasarela de IA interna.",
  "enterprise.faq.q2": "¿Cómo empiezo con Bugbee Enterprise?",
  "enterprise.faq.a2":
    "Simplemente empieza con una prueba interna con tu equipo. Bugbee por defecto no almacena tu código ni datos de contexto, haciendo fácil empezar. Luego contáctanos para discutir precios y opciones de implementación.",
  ...
  "enterprise.faq.q4": "¿Están mis datos seguros con Bugbee Enterprise?",
  "enterprise.faq.a4":
    "Sí. Bugbee no almacena tu código ni datos de contexto. Todo el procesamiento ocurre localmente o a través de llamadas directas a la API de tu proveedor de IA. Con configuración central y integración SSO, tus datos permanecen seguros dentro de la infraestructura de tu organización.",

  "brand.title": "Bugbee | Marca",
  "brand.meta.description": "Guías de marca de Bugbee",
  "brand.heading": "Guías de marca",
  "brand.subtitle": "Recursos y activos para ayudarte a trabajar con la marca Bugbee.",
  "brand.downloadAll": "Descargar todos los activos",

  "changelog.title": "Bugbee | Registro de cambios",
  "changelog.meta.description": "Notas de versión y registro de cambios de Bugbee",
  "changelog.hero.title": "Registro de cambios",
  "changelog.hero.subtitle": "Nuevas actualizaciones y mejoras para Bugbee",
