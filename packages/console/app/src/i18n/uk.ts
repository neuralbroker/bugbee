...
export const dict = {
  ...
  "notFound.title": "Не знайдено | bugbee",
  "notFound.heading": "404 — Сторінку не знайдено",
  "notFound.home": "Головна",
  "notFound.docs": "Документація",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "світлий логотип bugbee",
  "notFound.logoDarkAlt": "темний логотип bugbee",
  ...
  "app.meta.description": "Bugbee — відкритий агент для програмування.",

  "home.title": "Bugbee | Відкритий AI-агент для кодування",

  "temp.title": "bugbee | AI-агент для кодування, створений для термінала",
  ...
  "temp.feature.zen.afterLink": "від bugbee",
  "temp.feature.models.beforeLink": "Підтримує 75+ LLM-провайдерів через",
  "temp.feature.models.afterLink": ", включаючи локальні моделі",
  "temp.screenshot.caption": "Bugbee TUI з темою tokyonight",
  "temp.screenshot.alt": "Bugbee TUI з темою tokyonight",
  "temp.logoLightAlt": "світлий логотип bugbee",
  "temp.logoDarkAlt": "темний логотип bugbee",
  ...
  "home.what.title": "Що таке Bugbee?",
  "home.what.body": "Bugbee — це відкритий агент, який допомагає писати код у терміналі, IDE або на десктопі.",
  ...
  "home.growth.body":
    "З понад <strong>{{stars}}</strong> зірками на GitHub, <strong>{{contributors}}</strong> учасниками та понад <strong>{{commits}}</strong> комітами, Bugbee використовують понад <strong>{{monthlyUsers}}</strong> розробників щомісяця.",
  ...
  "home.privacy.body":
    "Bugbee не зберігає ваш код або контекстні дані, тому може працювати в середовищах з чутливими даними.",
  "home.privacy.learnMore": "Дізнатися більше про",
  "home.privacy.link": "конфіденційність",

  "home.faq.q1": "Що таке Bugbee?",
  "home.faq.a1":
    "Bugbee — це відкритий агент, який допомагає писати та запускати код з будь-якою AI-моделлю. Доступний як термінальний інтерфейс, десктопний застосунок або розширення IDE.",
  "home.faq.q2": "Як почати користуватися Bugbee?",
  "home.faq.a2.before": "Найпростіший спосіб почати — прочитати",
  "home.faq.a2.link": "вступ",
  "home.faq.q3": "Чи потрібні додаткові AI-підписки для використання Bugbee?",
  "home.faq.a3.p1":
    "Не обов'язково, Bugbee має набір безкоштовних моделей, які можна використовувати без реєстрації.",
  "home.faq.a3.p2.beforeZen":
    "Крім цього, ви можете використовувати будь-які популярні моделі, створивши обліковий запис",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Хоча ми рекомендуємо Zen, Bugbee також працює з усіма популярними провайдерами, такими як OpenAI, Anthropic, xAI тощо.",
  "home.faq.a3.p4.beforeLocal": "Ви навіть можете підключити свої",
  "home.faq.a3.p4.localLink": "локальні моделі",
  "home.faq.q4": "Чи можу я використовувати свої наявні AI-підписки з Bugbee?",
  "home.faq.a4.p1":
    "Так, Bugbee підтримує підписки всіх основних провайдерів. Ви можете використовувати Claude Pro/Max, ChatGPT Plus/Pro або GitHub Copilot.",
  "home.faq.q5": "Чи можна використовувати Bugbee лише в терміналі?",
  "home.faq.a5.beforeDesktop": "Вже ні! Bugbee тепер доступний як застосунок для",
  "home.faq.a5.desktop": "десктопа",
  "home.faq.a5.and": "та",
  "home.faq.a5.web": "вебу",
  "home.faq.q6": "Скільки коштує Bugbee?",
  "home.faq.a6":
    "Bugbee є 100% безкоштовним. Він також має набір безкоштовних моделей. Додаткові витрати можливі, якщо ви підключите іншого провайдера.",
  ...
  "home.faq.q8": "Чи є Bugbee відкритим?",
  "home.faq.a8.p1": "Так, Bugbee повністю відкритий. Вихідний код доступний публічно на",
  ...
  "home.zenCta.body":
    "Zen дає доступ до добірки AI-моделей, які Bugbee протестував спеціально для агентів кодування. Не турбуйтеся про нестабільну якість — використовуйте перевірені моделі.",
  "home.zenCta.link": "Дізнатися про Zen",

  "zen.title": "Bugbee Zen | Добірка надійних оптимізованих моделей для агентів кодування",
  "zen.hero.title": "Надійні оптимізовані моделі для агентів кодування",
  "zen.hero.body":
    "Zen дає доступ до добірки AI-моделей, які Bugbee протестував спеціально для агентів кодування. Не турбуйтеся про нестабільну якість — використовуйте перевірені моделі.",

  "zen.faq.q1": "Що таке Bugbee Zen?",
  "zen.faq.a1": "Zen — це добірка AI-моделей, протестованих для агентів кодування, створена командою Bugbee.",
  ...
  "zen.faq.a3":
    "Zen не є прибутковим. Zen передає вам вартість від провайдерів моделей. Чим вище використання Zen, тим кращі ціни Bugbee може узгодити та передати вам.",
  ...
  "zen.faq.a4.p3":
    "Щоб покрити витрати, Bugbee додає лише невелику комісію за обробку платежу в розмірі $1.23 за кожне поповнення балансу $20.",
  ...
  "zen.faq.a8":
    "Хоча Zen чудово працює з Bugbee, ви можете використовувати Zen з будь-яким агентом. Дотримуйтесь інструкцій з налаштування у вашому агенті.",
  ...
  "zen.problem.subtitle": "Ми вирішуємо це для всіх, а не лише для користувачів Bugbee.",
  ...
  "zen.how.body":
    "Хоча ми пропонуємо використовувати Zen з Bugbee, ви можете використовувати Zen з будь-яким агентом.",
  ...
  "go.title": "Bugbee Go | Недорогі моделі кодування для всіх",
  ...
  "go.problem.body":
    "Ми зосереджені на тому, щоб зробити досвід Bugbee доступним для якомога більшої кількості людей. Bugbee Go — це недорога підписка: $5 за перший місяць, потім $10/місяць. Вона надає щедрі ліміти та надійний доступ до найкращих моделей з відкритим кодом.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "Go починається від $5 за перший місяць, потім $10/місяць. Використовуйте з Bugbee або будь-яким агентом.",
  ...
  "zen.api.error.trialEnded":
    "Безкоштовна акція для {{model}} закінчилася. Ви можете продовжити використання, підписавшись на Bugbee Go — {{link}}",

  "black.meta.title": "Bugbee Black | Доступ до найкращих моделей кодування",
  "black.meta.description": "Отримайте доступ до Claude, GPT, Gemini та інших із планами підписки Bugbee Black.",
  "black.hero.title": "Доступ до найкращих моделей кодування",
  "black.hero.subtitle": "Включаючи Claude, GPT, Gemini та інші",
  "black.title": "Bugbee Black | Ціни",
  ...
  "black.workspace.title": "Bugbee Black | Виберіть робочий простір",
  "black.workspace.selectPlan": "Виберіть робочий простір для цього плану",
  "black.workspace.name": "Робочий простір {{n}}",
  "black.subscribe.title": "Підписатися на Bugbee Black",
  ...
  "black.subscribe.success.title": "Ви в списку очікування Bugbee Black",
  ...
  "workspace.newUser.step.login.after": "і виберіть bugbee",
  "workspace.newUser.step.pasteKey": "Вставте ключ API",
  "workspace.newUser.step.models.before": "Запустіть bugbee і виконайте",
  ...
  "workspace.keys.subtitle": "Керуйте ключами API для доступу до сервісів bugbee.",
  "workspace.keys.create": "Створити ключ API",
  "workspace.keys.placeholder": "Введіть назву ключа",
  "workspace.keys.empty": "Створіть ключ API шлюзу bugbee",
  ...
  "workspace.black.subscription.message": "Ви підписані на Bugbee Black за ${{plan}} на місяць.",
  ...
  "workspace.black.waitlist.joined": "Ви в списку очікування на план Bugbee Black за ${{plan}} на місяць.",
  "workspace.black.waitlist.ready": "Ми готові зареєструвати вас на план Bugbee Black за ${{plan}} на місяць.",
  ...
  "workspace.lite.subscription.message": "Ви підписані на Bugbee Go.",
  ...
  "workspace.lite.subscription.selectProvider": 'Виберіть "Bugbee Go" як провайдера в конфігурації bugbee.',
  ...
  "workspace.lite.black.message":
    "Ви вже підписані на Bugbee Black або в списку очікування. Спочатку скасуйте підписку, якщо хочете перейти на Go.",
  "workspace.lite.other.message": "Інший учасник цього робочого простору вже підписаний на Bugbee Go.",
  "workspace.lite.promo.description": "Bugbee Go починається від {{price}}, потім $10/місяць, із щедрими лімітами.",
  ...
  "download.title": "Bugbee | Завантажити",
  "download.meta.description": "Завантажте Bugbee для macOS, Windows та Linux",
  "download.hero.title": "Завантажити Bugbee Desktop",
  "download.hero.subtitle": "Доступно в бета-версії для macOS, Windows та Linux",
  "download.hero.button": "Завантажити для {{os}}",
  "download.section.terminal": "Термінал Bugbee",
  "download.section.desktop": "Десктоп Bugbee",
  "download.section.extensions": "Розширення Bugbee",
  "download.section.integrations": "Інтеграції Bugbee",
  ...
  "download.faq.a3.afterZen":
    ", Bugbee працює з усіма популярними провайдерами, такими як OpenAI, Anthropic, xAI тощо.",

  "download.faq.a5.p1": "Bugbee є 100% безкоштовним.",
  "download.faq.a5.p2.beforeZen":
    "Будь-які додаткові витрати будуть з вашої підписки у провайдера моделі. Ми рекомендуємо",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Ваші дані зберігаються лише при створенні посилань для обміну в Bugbee.",
  "download.faq.a6.p2.beforeShare": "Дізнайтеся більше про",
  "download.faq.a6.shareLink": "сторінки обміну",

  "enterprise.title": "Bugbee | Enterprise-рішення для вашої організації",
  "enterprise.meta.description": "Зв'яжіться з Bugbee для Enterprise-рішень",
  "enterprise.hero.title": "Ваш код належить вам",
  "enterprise.hero.body1":
    "Bugbee працює безпечно всередині вашої організації без зберігання даних, ліцензійних обмежень. Почніть пробний період із командою, потім розгорніть через SSO та внутрішній AI-шлюз.",
  ...
  "enterprise.faq.q1": "Що таке Bugbee Enterprise?",
  "enterprise.faq.a1":
    "Bugbee Enterprise для організацій, які хочуть гарантувати, що код і дані ніколи не залишають їхню інфраструктуру.",
  "enterprise.faq.q2": "Як почати з Bugbee Enterprise?",
  "enterprise.faq.a2":
    "Почніть із внутрішнього тестування з командою. Bugbee за замовчуванням не зберігає код. Потім зв'яжіться з нами для обговорення цін.",
  ...
  "enterprise.faq.q4": "Чи безпечні мої дані з Bugbee Enterprise?",
  "enterprise.faq.a4":
    "Так. Bugbee не зберігає ваш код або контекст. Вся обробка відбувається локально або через прямі API-виклики.",

  "brand.title": "Bugbee | Бренд",
  "brand.meta.description": "Рекомендації щодо бренду Bugbee",
  "brand.heading": "Рекомендації щодо бренду",
  "brand.subtitle": "Ресурси та матеріали для роботи з брендом Bugbee.",
  "brand.downloadAll": "Завантажити всі матеріали",

  "changelog.title": "Bugbee | Журнал змін",
  "changelog.meta.description": "Нотатки про випуски та журнал змін Bugbee",
  "changelog.hero.title": "Журнал змін",
  "changelog.hero.subtitle": "Нові оновлення та покращення Bugbee",
