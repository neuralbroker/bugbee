...
import video from "../asset/lander/bugbee-min.mp4"
import videoPoster from "../asset/lander/bugbee-poster.png"
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="curl">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span data-slot="command-script">
                        ...
                        <span data-slot="highlight">bugbee.dev/install</span>
                        <span> | bash</span>
                      </span>
                      <CopyStatus />
                    </button>
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="npm">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">bugbee-ai</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="brew">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">neuralbroker/tap/bugbee</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
                  <Tabs.Content as="pre" data-slot="panel" value="paru">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">bugbee</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
