        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              ...
              <button data-component="cli-row" onClick={handleCopyClick("paru -S bugbee")}>
                <code>
                  paru -S <strong>bugbee</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask bugbee-desktop")}>
                <code>
                  brew install --cask <strong>bugbee-desktop</strong>
                </code>
                <CopyStatus />
              </button>
