...
import compareVideo from "../../asset/lander/bugbee-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/bugbee-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="bugbee:auth" content={loggedin() ? "true" : "false"} />
