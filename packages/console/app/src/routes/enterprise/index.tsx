              ...
              <div data-component="enterprise-column-1">
                ...
                <Show when={false}>
                  <div data-component="testimonial">
                    ...
                    Thanks to Bugbee, we found a way to create software to track all our assets — even the imaginary
                    ones.
            ...
            <ul>
              ...
              <li>
                <Faq question={i18n.t("enterprise.faq.q5")}>
                  {i18n.t("enterprise.faq.a5.before")} <a href="https://trust.bugbee.ai">trust.bugbee.ai</a>{" "}
