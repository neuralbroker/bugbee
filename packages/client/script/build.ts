...
import { compile, emitEffectImported, emitPromise, write } from "@bugbee-ai/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "BugbeeEventEncoded",
              import: 'import type { BugbeeEventEncoded } from "@bugbee-ai/protocol/groups/event"',
            },
          },
        }),
