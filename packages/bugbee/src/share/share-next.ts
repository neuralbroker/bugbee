...
import type * as SDK from "@bugbee-ai/sdk/v2"
...
import { SessionShareTable } from "@bugbee-ai/core/share/sql"
...
const disabled = process.env["BUGBEE_DISABLE_SHARE"] === "true" || process.env["BUGBEE_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@bugbee/ShareNext") {}
