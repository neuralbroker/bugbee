...
export class Service extends Context.Service<Service, Interface>()("@bugbee/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __BUGBEE_PHOTON_WASM_PATH?: string }).__BUGBEE_PHOTON_WASM_PATH =
