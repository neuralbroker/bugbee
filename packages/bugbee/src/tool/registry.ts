...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@bugbee-ai/plugin"
...
export function webSearchEnabled(providerID: ProviderV2.ID, flags = { exa: false, parallel: false }) {
  return providerID === ProviderV2.ID.bugbee || flags.exa || flags.parallel
}
...
export class Service extends Context.Service<Service, Interface>()("@bugbee/ToolRegistry") {}
