...
import { ProjectDirectoryTable, ProjectTable } from "@bugbee-ai/core/project/sql"
import { ProjectDirectories } from "@bugbee-ai/core/project/directories"
...
import { which } from "@bugbee-ai/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@bugbee/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.BUGBEE_FAKE_VCS)
