...
import { EventSequenceTable, EventTable } from "@bugbee-ai/core/event/sql"
...
import { WorkspaceEvent } from "@bugbee-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@bugbee/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        BUGBEE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        BUGBEE_WORKSPACE_ID: config.id,
        BUGBEE_EXPERIMENTAL_WORKSPACES: "true",
