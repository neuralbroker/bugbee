// Bugbee publish boundary for core events. Attach routed instance location
...
export class Service extends Context.Service<Service, EventV2.Interface>()("@bugbee/EventV2Bridge") {}
