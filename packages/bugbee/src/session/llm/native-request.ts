import type { JsonSchema, LLMRequest, ProviderMetadata } from "@bugbee-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@bugbee-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @bugbee-ai/llm request objects from bugbee's session/AI SDK-shaped data.
  return LLM.request({
