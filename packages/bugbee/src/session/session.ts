...
import { Slug } from "@bugbee-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@bugbee-ai/llm"
...
import { locationServiceMapLayer } from "@bugbee-ai/core/location-services"
...
import { PartTable, SessionTable } from "@bugbee-ai/core/session/sql"
...
import { NonNegativeInt, optional } from "@bugbee-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".bugbee", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@bugbee/Session") {}
