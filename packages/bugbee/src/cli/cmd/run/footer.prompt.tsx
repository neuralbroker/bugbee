...
import { normalizePromptContent } from "@bugbee-ai/tui/editor"
...
import { BUGBEE_BASE_MODE, useBindings } from "@bugbee-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Bugbee" } satisfies SlashOption,
    ]
