...
import type { Event, GlobalEvent, BugbeeClient } from "@bugbee-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@bugbee/RunStreamTransport") {}
