...
//
// The saved variant persists across sessions in ~/.local/state/bugbee/model.json
...
class Service extends Context.Service<Service, VariantService>()("@bugbee/RunVariant") {}
