...
import { openEditor } from "@bugbee-ai/tui/editor"
import { registerBugbeeKeymap } from "@bugbee-ai/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerBugbeeKeymap(keymap, renderer, input.tuiConfig)
