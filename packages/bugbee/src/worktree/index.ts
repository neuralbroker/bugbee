...
import { path } from "@bugbee-ai/core/effect/app-node-platform"
...
import type { ProjectV2 } from "@bugbee-ai/core/project"
...
import { WorktreeEvent } from "@bugbee-ai/schema/worktree-event"
...
export class Service extends Context.Service<Service, Interface>()("@bugbee/Worktree") {}
  ...
  Effect.gen(function* () {
    ...
    const candidate = Effect.fn("Worktree.candidate")(function* (input: {
      ...
      for (const attempt of Array.from({ length: MAX_NAME_ATTEMPTS }, (_, i) => i)) {
        ...
        const branch = input.detached ? undefined : `bugbee/${name}`
