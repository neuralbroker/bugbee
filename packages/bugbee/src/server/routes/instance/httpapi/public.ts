...
const LegacyComponentDescriptions: Record<string, string> = {
  LogLevel: "Log level",
  ServerConfig: "Server configuration for bugbee serve and web commands",
...
function fixSelfReferencingComponents(spec: OpenApiSpec) {
  ...
  const raw: OpenApiSpec = OpenApi.fromApi(BugbeeHttpApi)
...
export const PublicApi = BugbeeHttpApi.annotateMerge(
  OpenApi.annotations({
    title: "bugbee",
    version: "1.0.0",
    description: "bugbee api",
