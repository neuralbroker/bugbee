...
import { makeApi } from "@bugbee-ai/protocol/api"
import { LocationMiddleware } from "@bugbee-ai/server/location"
import { SessionLocationMiddleware } from "@bugbee-ai/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("bugbee-root")
...
export const InstanceHttpApi = HttpApi.make("bugbee-instance")
...
export const BugbeeHttpApi = HttpApi.make("bugbee")
