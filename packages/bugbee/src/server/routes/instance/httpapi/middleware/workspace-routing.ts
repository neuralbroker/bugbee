...
>()("@bugbee/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@bugbee/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.BUGBEE_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.BUGBEE_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-bugbee-directory"] || process.cwd()
}
