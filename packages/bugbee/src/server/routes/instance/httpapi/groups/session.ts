...
export const SessionApi = HttpApi.make("session")
      ...
      .add(
        HttpApiEndpoint.get("list", SessionPaths.list, {
          ...
          OpenApi.annotations({
            ...
            description: "Get a list of all Bugbee sessions, sorted by most recently updated.",
          }),
        ),
        ...
        HttpApiEndpoint.get("get", SessionPaths.get, {
          ...
          OpenApi.annotations({
            ...
            summary: "Get session",
            description: "Retrieve detailed information about a specific Bugbee session.",
          }),
        ),
        ...
        HttpApiEndpoint.post("create", SessionPaths.create, {
          ...
          OpenApi.annotations({
            ...
            description: "Create a new Bugbee session for interacting with AI assistants and managing conversations.",
          }),
        ),
  ...
  .annotateMerge(
    OpenApi.annotations({
      title: "bugbee experimental HttpApi",
      version: "0.0.1",
