...
import type { AssistantMessage as BugbeeAssistantMessage, Message } from "@bugbee-ai/sdk/v2"
import { InstanceRef } from "@/effect/instance-ref"
import { InstanceBootstrap } from "@/project/bootstrap"
import { InstanceStore } from "@/project/instance-store"
import { makeGlobalNode, Node } from "@bugbee-ai/core/effect/app-node"
...
export type AssistantTokenCost = Pick<BugbeeAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<BugbeeAssistantMessage, "role"> &
  Partial<Pick<BugbeeAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@bugbee/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@bugbee/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@bugbee/ACPUsage") {}
