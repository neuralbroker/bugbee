...
import { AccountStateTable, AccountTable } from "@bugbee-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@bugbee/AccountRepo") {}
