import type { Hooks, PluginInput } from "@bugbee-ai/plugin"
import type { Model } from "@bugbee-ai/sdk/v2"
import { InstallationVersion } from "@bugbee-ai/core/installation/version"
import { OauthCallbackPage } from "@bugbee-ai/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. Bugbee will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
