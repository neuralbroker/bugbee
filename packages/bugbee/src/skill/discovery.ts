...
import { httpClient, path } from "@bugbee-ai/core/effect/app-node-platform"
...
export class Service extends Context.Service<Service, Interface>()("@bugbee/SkillDiscovery") {}
      ...
      const dirs = yield* Effect.forEach(
        ...
        (skill) =>
          Effect.gen(function* () {
            ...
            const versionFile = path.join(root, ".bugbee-version")
            ...
            if (version === undefined || current === version) {
              ...
              yield* Effect.gen(function* () {
                ...
                yield* fs.writeFileString(path.join(staging, ".bugbee-version"), version)
