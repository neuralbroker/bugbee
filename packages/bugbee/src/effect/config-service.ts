 ...
 *   "@bugbee/ServerAuthConfig",
 *   {
 *     password: Config.string("BUGBEE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("BUGBEE_SERVER_USERNAME").pipe(Config.withDefault("bugbee")),
 *   },
 * ) {}
 *
