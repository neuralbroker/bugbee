...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/bugbee.git")).toEqual({ owner: "sst", repo: "bugbee" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/bugbee")).toEqual({ owner: "sst", repo: "bugbee" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/bugbee.git")).toEqual({ owner: "sst", repo: "bugbee" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/bugbee")).toEqual({ owner: "sst", repo: "bugbee" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/bugbee.git")).toEqual({ owner: "sst", repo: "bugbee" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/bugbee")).toEqual({ owner: "sst", repo: "bugbee" })
})
