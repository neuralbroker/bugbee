...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders BUGBEE_CALLER", () => {
    process.env["BUGBEE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode BUGBEE_CALLER", () => {
    process.env["BUGBEE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown BUGBEE_CALLER", () => {
    process.env["BUGBEE_CALLER"] = "unknown"
