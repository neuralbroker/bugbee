...
import { makeGlobalNode } from "@bugbee-ai/core/effect/app-node"
...
import { InstallationChannel } from "@bugbee-ai/core/installation/version"
  ...
  describe("latest", () => {
    ...
    testEffect(
      ...
      Effect.gen(function* () {
        ...
        expect(npmCalls).toContain(`https://registry.npmjs.org/@neuralbroker%2fbugbee/${InstallationChannel}`)
      }),
    )
    ...
    testEffect(
      ...
      Effect.gen(function* () {
        ...
        expect(bunCalls).toContain(`https://registry.npmjs.org/@neuralbroker%2fbugbee/${InstallationChannel}`)
      }),
    )
    ...
    testEffect(
      ...
      Effect.gen(function* () {
        ...
        expect(pnpmCalls).toContain(`https://registry.npmjs.org/@neuralbroker%2fbugbee/${InstallationChannel}`)
      }),
    )
    ...
    testEffect(
      testLayer(
        ...
        (cmd, args) => {
          ...
          if (cmd === "brew" && args.includes("--formula") && args.includes("neuralbroker/tap/bugbee")) return ""
          if (cmd === "brew" && args.includes("--formula") && args.includes("bugbee")) return "bugbee"
          return ""
        },
      ),
    ...
    testEffect(
      testLayer(
        ...
        (cmd, args) => {
          if (cmd === "brew" && args.includes("neuralbroker/tap/bugbee") && args.includes("--formula")) return "bugbee"
