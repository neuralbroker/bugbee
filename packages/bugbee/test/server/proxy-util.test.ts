...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips bugbee-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-bugbee-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-bugbee-directory")).toBeNull()
      expect(result.get("x-bugbee-workspace")).toBeNull()
