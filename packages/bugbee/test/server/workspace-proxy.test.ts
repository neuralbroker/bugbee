...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips bugbee-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-bugbee-directory"]).toBeUndefined()
      expect(forwarded["x-bugbee-workspace"]).toBeUndefined()
