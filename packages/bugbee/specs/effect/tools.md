...
Practical reference for the current tool-migration state in `packages/bugbee`.
...
Tool tests should use the existing Effect helpers in `packages/bugbee/test/lib/effect.ts`:
