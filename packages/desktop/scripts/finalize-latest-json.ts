...
const releaseId = process.env.BUGBEE_RELEASE
if (!releaseId) throw new Error("BUGBEE_RELEASE is required")

const version = process.env.BUGBEE_VERSION
if (!version) throw new Error("BUGBEE_VERSION is required")
...
const macxTarGz = "bugbee-desktop-mac-x64.app.tar.gz"
const macaTarGz = "bugbee-desktop-mac-arm64.app.tar.gz"
