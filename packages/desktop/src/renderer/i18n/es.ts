export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Bugbee",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Bugbee. ¿Quieres instalarla y reiniciar?",
