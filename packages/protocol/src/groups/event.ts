...
import { EventManifest } from "@bugbee-ai/schema/event-manifest"
import { Location } from "@bugbee-ai/schema/location"
import type { Definition } from "@bugbee-ai/schema/event"
...
export const BugbeeEvent = event.schema
export type BugbeeEvent = typeof BugbeeEvent.Type
export type BugbeeEventEncoded = typeof BugbeeEvent.Encoded
