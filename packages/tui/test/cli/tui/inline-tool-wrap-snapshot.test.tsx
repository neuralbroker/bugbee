...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "BUGBEE.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/bugbee/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/bugbee (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/bugbee/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/bugbee/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const BUGBEE_DB|BUGBEE_DB|BUGBEE_DEV|Global\\.Path\\.data|data =" in packages/bugbee/src (115 matches)',
  },
] as const
