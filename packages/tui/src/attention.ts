...
import defaultSoundPath from "@bugbee-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@bugbee-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@bugbee-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@bugbee-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@bugbee-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@bugbee-ai/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "bugbee"
const DEFAULT_PACK_ID = "bugbee.default"
