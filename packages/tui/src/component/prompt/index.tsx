...
import { registerBugbeeSpinner } from "../register-spinner"
...
import type { AssistantMessage, FilePart, UserMessage } from "@bugbee-ai/sdk/v2"
...
import { BUGBEE_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useBugbeeKeymap } from "../../keymap"
...
export function Prompt(props: PromptProps) {
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.BUGBEE_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
  ...
  const placeholderText = createMemo(() => {
    ...
    return `BUGBEE · Ask anything... "${list()[store.placeholder % list().length]}"`
  })
