...
O esquema de configuração do servidor/tempo de execução é definido em [**`bugbee.dev/config.json`**](https://bugbee.dev/config.json).

A configuração do TUI usa [**`bugbee.dev/tui.json`**](https://bugbee.dev/tui.json).
