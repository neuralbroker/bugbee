...
1. Execute o comando `/connect` no TUI, selecione `Bugbee Zen` e acesse [bugbee.dev/zen](https://github.com/neuralbroker/bugbee/zen).
...
1. Execute o comando `/connect` no TUI, selecione `Bugbee Go` e acesse [bugbee.dev/zen](https://github.com/neuralbroker/bugbee/zen).
