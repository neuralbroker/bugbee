...
Você pode definir servidores MCP em sua [Configuração do bugbee](https://bugbee.dev/docs/config/) sob `mcp`. Adicione cada MCP com um nome único. Você pode se referir a esse MCP pelo nome ao solicitar ao LLM.
