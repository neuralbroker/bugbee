...
1. 在 TUI 中執行 `/connect` 指令，選擇 `Bugbee Zen`，然後前往 [bugbee.dev/auth](https://bugbee.dev/auth)。
...
1. 在 TUI 中執行 `/connect` 指令，選擇 `Bugbee Go`，然後前往 [bugbee.dev/auth](https://bugbee.dev/auth)。
