...
The server/runtime config schema is defined in [**`bugbee.dev/config.json`**](https://bugbee.dev/config.json).

TUI config uses [**`bugbee.dev/tui.json`**](https://bugbee.dev/tui.json).
