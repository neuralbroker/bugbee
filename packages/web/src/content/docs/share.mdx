---
title: Share
description: Share your Bugbee conversations.
---

Bugbee's share feature allows you to create public links to your Bugbee conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, Bugbee:
...
Bugbee supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, Bugbee uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `bugbee.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using bugbee in your organization.
