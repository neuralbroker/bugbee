...
Erstellen Sie `.bugbee/commands/test.md`:

```md title=".bugbee/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die Bugbee-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Bugbee [config](/docs/config):

```json title="bugbee.jsonc" {4-12}
{
...
- Global: `~/.config/bugbee/commands/`
- Pro Projekt: `.bugbee/commands/`

```markdown title="~/.config/bugbee/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".bugbee/commands/component.md"
---
...
```md title=".bugbee/commands/create-file.md"
---
...
```md title=".bugbee/commands/analyze-coverage.md"
---
...
```md title=".bugbee/commands/review-changes.md"
---
...
```md title=".bugbee/commands/review-component.md"
---
...
Bugbee enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
