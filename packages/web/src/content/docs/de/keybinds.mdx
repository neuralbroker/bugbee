...
Bugbee verfügt über eine Liste von Tastenkombinationen, die Sie über `tui.json` anpassen können.
...
Bugbee verwendet für die meisten Keybinds einen `leader`-Schlüssel. Dies vermeidet Konflikte in Ihrem Terminal.
...
Die Eingabeaufforderungseingabe der Bugbee-Desktop-App unterstützt gängige Readline/Emacs-style-Verknüpfungen zum Bearbeiten von Text. Diese sind integriert und derzeit nicht über `bugbee.json` konfigurierbar.
