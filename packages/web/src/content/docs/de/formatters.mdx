---
title: Formatierer
description: Bugbee verwendet sprachspezifische Formatierer.
---

Bugbee formatiert Dateien automatisch, nachdem sie mit sprachspezifischen Formatierern geschrieben oder bearbeitet wurden. Dadurch wird sichergestellt, dass der generierte Code dem Codestil Ihres Projekts entspricht.

---

## Integriert

Bugbee verfügt über mehrere integrierte Formatierer für gängige Sprachen und Frameworks. Nachfolgend finden Sie eine Liste der Formatierer, unterstützten Dateierweiterungen und benötigten Befehle oder Konfigurationsoptionen.
...
Wenn Ihr Projekt auch `prettier` in Ihrem `package.json` hat, wird Bugbee automatisch verwendet.

---

## Funktionsweise

Wenn Bugbee eine Datei schreibt oder bearbeitet, geschieht Folgendes:
...
Sie können Formatierer über den Abschnitt `formatter` in Ihrer Bugbee-Konfiguration anpassen.
