---
title: Teilen
description: Teile Bugbee-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Bugbee-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Bugbee Folgendes:
...
Bugbee hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Bugbee den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`bugbee.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du bugbee in deiner Organisation einsetzt.
