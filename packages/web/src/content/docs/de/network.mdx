...
Bugbee unterstützt Standard-Proxy-Umgebungsvariablen und benutzerdefinierte Zertifikate für Unternehmensnetzwerkumgebungen.

---

## Proxy

Bugbee respektiert Standard-Proxy-Umgebungsvariablen.
...
Wenn Ihr Unternehmen benutzerdefinierte Zertifizierungsstellen für HTTPS-Verbindungen verwendet, konfigurieren Sie Bugbee so, dass es ihnen vertraut.
