...
1. Führen Sie den Befehl `/connect` in TUI aus, wählen Sie Bugbee aus und gehen Sie zu [bugbee.dev/auth](https://github.com/neuralbroker/bugbee/auth).
...
1. Führen Sie den Befehl `/connect` in der TUI aus, waehlen Sie `Bugbee Go` und gehen Sie zu [bugbee.dev/auth](https://github.com/neuralbroker/bugbee/zen).
