...
يوفّر Bugbee قائمة باختصارات لوحة المفاتيح يمكنك تخصيصها عبر إعدادات Bugbee.
...
يستخدم Bugbee مفتاح `leader` لمعظم اختصارات لوحة المفاتيح. يساعد ذلك على تجنّب التعارضات في terminal لديك.
...
يدعم حقل إدخال الموجّه في تطبيق Bugbee لسطح المكتب اختصارات شائعة لتحرير النص على نمط Readline/Emacs. هذه الاختصارات مدمجة حاليا ولا يمكن تخصيصها عبر `bugbee.json`.
