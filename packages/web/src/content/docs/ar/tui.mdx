---
title: TUI
description: استخدام واجهة المستخدم TUI في Bugbee.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر Bugbee واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل Bugbee إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة Bugbee في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى Bugbee. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من Bugbee. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `bugbee.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار Bugbee بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `bugbee.default`.
