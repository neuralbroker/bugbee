---
title: خوادم LSP
description: يتكامل Bugbee مع خوادم LSP لديك.
---

يمكن أن يتكامل Bugbee مع خوادم Language Server Protocol (LSP) لاستخدام التشخيصات كملاحظات للوكيل.

---

## المدمجة

يأتي Bugbee مع عدة خوادم LSP مدمجة للغات الشائعة:
...
:::note
يمكنك تعطيل تنزيلات خوادم LSP التلقائية عبر ضبط متغير البيئة `BUGBEE_DISABLE_LSP_DOWNLOAD` على `true`.
:::
...
عند تفعيل LSP وفتح bugbee لملف، فإنه:
...
يمكنك تفعيل خوادم LSP وتخصيصها عبر قسم `lsp` في إعدادات bugbee.
