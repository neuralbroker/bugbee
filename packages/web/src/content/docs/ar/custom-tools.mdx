...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في bugbee.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في bugbee مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.bugbee/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/bugbee/tools/`.
