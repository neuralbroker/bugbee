...
1. شغّل الأمر `/connect` في TUI، واختر bugbee، ثم انتقل إلى [bugbee.dev/auth](https://github.com/neuralbroker/bugbee/auth).
...
1. شغّل الأمر `/connect` في TUI، واختر `Bugbee Go`، ثم انتقل إلى [bugbee.dev/auth](https://github.com/neuralbroker/bugbee/zen).
