...
Utwórz `.bugbee/commands/test.md`:
...
Możesz zdefiniować polecenia w `bugbee.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji bugbee:
...
- Globalnie: `~/.config/bugbee/commands/`
- Na projekt: `.bugbee/commands/`
...
bugbee zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
