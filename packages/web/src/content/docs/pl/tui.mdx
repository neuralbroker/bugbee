---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala bugbee.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

bugbee zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie bugbee uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI bugbee, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do bugbee. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij bugbee. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `bugbee.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo Bugbee czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `bugbee.default`.
