...
1. Uruchom polecenie `/connect` w TUI, wybierz `Bugbee Zen` i przejdź do [bugbee.dev/auth](https://bugbee.dev/auth).
...
1. Uruchom polecenie `/connect` w TUI, wybierz `Bugbee Go` i przejdź do [bugbee.dev/auth](https://bugbee.dev/auth).
