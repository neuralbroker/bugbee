---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące bugbee.
---

Funkcja udostępniania bugbee umożliwia tworzenie publicznych linków do konwersacji bugbee, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, bugbee:
...
bugbee obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie bugbee korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `bugbee.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu bugbee w Twojej organizacji.
