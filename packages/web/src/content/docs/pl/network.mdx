...
bugbee obsługa standardowego zmiennego proxy i certyfikatów dla usług sieciowych przedsiębiorstw.

---

## Pełnomocnik

bugbee respektuje standardowe zmienne środowiskowe proxy.
...
Jeśli Twoje przedsiębiorstwo korzysta z niestandardowych usług, urzędów dostępu do HTTPS, skonfiguruj bugbee tak, aby im ufać.
