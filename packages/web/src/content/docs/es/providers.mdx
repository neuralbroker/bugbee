...
1. Ejecute el comando `/connect` en TUI, seleccione bugbee y diríjase a [bugbee.dev/auth](https://github.com/neuralbroker/bugbee/auth).
...
1. Ejecute el comando `/connect` en TUI, seleccione `Bugbee Go` y diríjase a [bugbee.dev/auth](https://github.com/neuralbroker/bugbee/zen).
