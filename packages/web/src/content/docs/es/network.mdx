...
Bugbee admite variables de entorno de proxy estándar y certificados personalizados para entornos de red empresarial.

---

## Proxy

Bugbee respeta las variables de entorno de proxy estándar.
...
Si su empresa utiliza CA personalizadas para conexiones HTTPS, configure Bugbee para confiar en ellas.
