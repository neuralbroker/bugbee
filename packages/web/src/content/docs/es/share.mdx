---
title: Compartir
description: Comparte tus conversaciones Bugbee.
---

La función para compartir de Bugbee te permite crear enlaces públicos a tus conversaciones de Bugbee, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, Bugbee:
...
Bugbee admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, Bugbee usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
...
Para aplicar esto en todo su equipo para un proyecto determinado, agréguelo al `bugbee.json` en su proyecto y regístrelo en Git.
...
[Obtenga más información](/docs/enterprise) sobre el uso de bugbee en su organización.
