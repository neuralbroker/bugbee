...
Puede agregar comandos personalizados a través de la configuración Bugbee o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Bugbee [config](/docs/config):
...
bugbee incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
