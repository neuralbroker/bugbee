...
Puoi definire server MCP nella tua [Bugbee Config](https://bugbee.dev/docs/config/) sotto `mcp`. Aggiungi ogni MCP con un nome univoco. Puoi riferirti a quell'MCP per nome quando fai prompt all'LLM.
