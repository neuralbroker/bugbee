...
Puoi aggiungere comandi personalizzati tramite la config di Bugbee o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Bugbee:
...
- Globale: `~/.config/bugbee/commands/`
- Per progetto: `.bugbee/commands/`
...
bugbee include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
