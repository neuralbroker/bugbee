...
Il file di configurazione ha uno schema definito in [**`bugbee.dev/config.json`**](https://bugbee.dev/config.json).

La configurazione TUI usa [**`bugbee.dev/tui.json`**](https://bugbee.dev/tui.json).
