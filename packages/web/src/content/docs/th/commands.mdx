...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Bugbee:
...
- ระดับผู้ใช้ (Global): `~/.config/bugbee/commands/`
- ระดับโปรเจ็กต์: `.bugbee/commands/`
...
Bugbee มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
