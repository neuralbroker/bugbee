...
1. เรียกใช้คำสั่ง `/connect` ใน TUI เลือก bugbee และไปที่ [bugbee.dev/auth](https://github.com/neuralbroker/bugbee/auth)
...
1. เรียกใช้คำสั่ง `/connect` ใน TUI เลือก `Bugbee Go` และไปที่ [bugbee.dev/auth](https://github.com/neuralbroker/bugbee/zen)
