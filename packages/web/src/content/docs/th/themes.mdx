...
ด้วย Bugbee คุณสามารถเลือกจากหนึ่งในธีมที่มีอยู่แล้วภายใน ใช้ธีมที่ปรับให้เข้ากับธีม terminal ของคุณ หรือกำหนดธีมที่คุณกำหนดเองได้

ตามค่าเริ่มต้น Bugbee จะใช้ธีม `bugbee` ของเราเอง
...
Bugbee มาพร้อมกับธีมในตัวหลายธีม
...
- ต้องการให้ Bugbee ตรงกับรูปลักษณ์ของ terminal
...
Bugbee รองรับระบบธีมที่ใช้ JSON ที่ยืดหยุ่น ซึ่งช่วยให้ผู้ใช้สามารถสร้างและปรับแต่งธีมได้อย่างง่ายดาย
...
2. **ไดเรกทอรีกำหนดค่าผู้ใช้** - กำหนดใน `~/.config/bugbee/themes/*.json` หรือ `$XDG_CONFIG_HOME/bugbee/themes/*.json`
3. **ไดเรกทอรีรากของโครงการ** - กำหนดไว้ใน `<project-root>/.bugbee/themes/*.json`
4. **ไดเร็กทอรีการทำงานปัจจุบัน** - กำหนดใน `./.bugbee/themes/*.json`
