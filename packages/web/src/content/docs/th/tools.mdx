...
เครื่องมืออนุญาตให้ LLM ดำเนินการในโค้ดเบสของคุณ Bugbee มาพร้อมกับชุดเครื่องมือในตัว แต่คุณสามารถขยายได้ด้วย [เครื่องมือที่กำหนดเอง](/docs/custom-tools) หรือ [MCP เซิร์ฟเวอร์](/docs/mcp-servers)
...
นี่คือเครื่องมือในตัวทั้งหมดที่มีอยู่ใน Bugbee
...
:::note
เครื่องมือนี้ใช้ได้เฉพาะเมื่อ `BUGBEE_EXPERIMENTAL_LSP_TOOL=true` (หรือ `BUGBEE_EXPERIMENTAL=true`)
:::
...
:::note
เครื่องมือนี้ใช้ได้เฉพาะเมื่อใช้ผู้ให้บริการ Bugbee หรือเมื่อตัวแปรสภาพแวดล้อม `BUGBEE_ENABLE_EXA` ถูกตั้งค่าเป็นค่าความจริง (เช่น `true` หรือ `1`)

หากต้องการเปิดใช้งานเมื่อเปิดตัว Bugbee:
