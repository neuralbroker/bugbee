---
title: TUI
description: การใช้อินเทอร์เฟซผู้ใช้ terminal Bugbee
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Bugbee มีอินเทอร์เฟซ terminal แบบโต้ตอบหรือ TUI สำหรับการทำงานในโครงการของคุณด้วย LLM

การรัน Bugbee จะเริ่มต้น TUI สำหรับไดเร็กทอรีปัจจุบัน
...
เมื่อใช้ Bugbee TUI คุณสามารถพิมพ์ `/` ตามด้วยชื่อคำสั่งเพื่อดำเนินการอย่างรวดเร็ว ตัวอย่างเช่น:
...
เพิ่มผู้ให้บริการให้กับ Bugbee ให้คุณเลือกจากผู้ให้บริการที่มีอยู่และเพิ่มคีย์ API
...
สิ่งนี้แยกจาก `bugbee.json` ซึ่งกำหนดค่าพฤติกรรมเซิร์ฟเวอร์/รันไทม์
...
- `leader_timeout` - ควบคุมระยะเวลาที่ Bugbee จะรอหลังจากกด leader key ค่าเริ่มต้นคือ `2000`
...
- `sound_pack` - sound pack ID ที่จะใช้ ค่าเริ่มต้นคือ `bugbee.default`
