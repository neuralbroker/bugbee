...
1. Run the `/connect` command in the TUI, select `Bugbee Zen`, and head to [bugbee.dev/auth](https://github.com/neuralbroker/bugbee/zen).
...
1. Run the `/connect` command in the TUI, select `Bugbee Go`, and head to [bugbee.dev/auth](https://github.com/neuralbroker/bugbee/zen).
