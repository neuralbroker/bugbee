...
1. Run the `/connect` command in the TUI, select `Bugbee Zen`, and head to [bugbee.dev/auth](https://bugbee.dev/auth).
...
1. Run the `/connect` command in the TUI, select `Bugbee Go`, and head to [bugbee.dev/auth](https://bugbee.dev/auth).
