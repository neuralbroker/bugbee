...
server/runtime config schema는 [**`bugbee.dev/config.json`**](https://bugbee.dev/config.json)에 정의되어 있습니다.

TUI config는 [**`bugbee.dev/tui.json`**](https://bugbee.dev/tui.json)을 사용합니다.
