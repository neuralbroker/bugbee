---
title: Dijeljenje
description: Dijelite Bugbee razgovore javnim linkovima.
---

Bugbee opcija dijeljenja vam omogucava da kreirate javne linkove za razgovore. Tako lakse saradujete s timom ili trazite pomoc od drugih.
...
Kada podijelite razgovor, Bugbee:
...
Bugbee podrzava tri nacina dijeljenja koji odreduju kako se razgovori dijele:

---

### Ručno (zadano)

Po defaultu, Bugbee koristi rucni nacin dijeljenja. Sesije se ne dijele automatski, ali ih mozete rucno podijeliti komandom `/share`:
...
Da ovo vazi za cijeli tim u odredenom projektu, dodajte postavku u projektni `bugbee.json` i commitujte u Git.
...
[Saznajte vise](/docs/enterprise) o koristenju bugbee u organizaciji.
