...
1. Pokrenite naredbu `/connect` u TUI-u, odaberite bugbee i idite na [bugbee.dev/auth](https://github.com/neuralbroker/bugbee/auth).
...
1. Pokrenite naredbu `/connect` u TUI-u, odaberite `Bugbee Go` i idite na [bugbee.dev/auth](https://github.com/neuralbroker/bugbee/zen).
