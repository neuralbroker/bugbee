...
Možete definirati MCP servere u vašoj [Bugbee Config](https://bugbee.dev/docs/config/) pod `mcp`. Dodajte svaki MCP sa jedinstvenim imenom. Možete se pozvati na taj MCP po imenu kada tražite LLM.
