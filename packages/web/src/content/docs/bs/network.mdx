...
Bugbee podržava standardne proxy varijable okruženja i prilagođene certifikate za enterprise mrežna okruženja.

## Proksi

Bugbee poštuje standardne varijable proxy okruženja.
...
Ako vaše preduzeće koristi prilagođene CA-ove za HTTPS veze, konfigurirajte Bugbee da im vjeruje.
