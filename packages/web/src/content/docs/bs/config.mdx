...
Konfiguracijski fajl ima šemu koja je definirana u [**`bugbee.dev/config.json`**](https://bugbee.dev/config.json).

TUI konfiguracija koristi [**`bugbee.dev/tui.json`**](https://bugbee.dev/tui.json).
