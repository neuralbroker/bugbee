---
title: TUI
description: Korištenje korisničkog interfejsa Bugbee terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Bugbee pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Bugbee pokreće TUI za trenutni direktorij.
...
Kada koristite Bugbee TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Bugbee. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Bugbee. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `bugbee.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo Bugbee čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `bugbee.default`.
