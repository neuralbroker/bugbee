...
Kreiraj `.bugbee/commands/test.md`:
...
Možete dodati prilagođene komande kroz Bugbee konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Bugbee [config](/docs/config):
...
- Globalno: `~/.config/bugbee/commands/`
- Po projektu: `.bugbee/commands/`
...
Bugbee uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
