...
1. TUI で `/connect` コマンドを実行し、`Bugbee Zen` を選択して、[bugbee.dev/zen](https://github.com/neuralbroker/bugbee/zen) にアクセスします。
...
1. TUI で `/connect` コマンドを実行し、`Bugbee Go` を選択して、[bugbee.dev/zen](https://github.com/neuralbroker/bugbee/zen) にアクセスします。
