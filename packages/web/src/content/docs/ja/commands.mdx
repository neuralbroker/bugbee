...
`.bugbee/commands/test.md` を作成します。
...
カスタムコマンドは、Bugbee 設定を通じて、または `commands/` ディレクトリに Markdown ファイルを作成することによって追加できます。

---

### JSON

Bugbee [設定](/docs/config)で `command` オプションを使用します:
...
- グローバル: `~/.config/bugbee/commands/`
- プロジェクトごと: `.bugbee/commands/`
...
Bugbee には、`/init`、`/undo`、`/redo`、`/share`、`/help` などのいくつかの組み込みコマンドが含まれています。 [詳細はこちら](/docs/tui#commands)。
