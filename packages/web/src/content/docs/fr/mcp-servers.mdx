...
Vous pouvez définir des serveurs MCP dans votre [Bugbee Config](https://bugbee.dev/docs/config/) sous `mcp`. Ajoutez chaque MCP avec un nom unique. Vous pouvez faire référence à ce MCP par son nom lorsque vous demandez le LLM.
