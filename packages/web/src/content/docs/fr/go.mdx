...
Bugbee Go est un abonnement à bas coût — **5 $ pour votre premier mois**, puis **10 $/mois** — qui vous donne un accès fiable aux modèles de codage ouverts populaires.

Go fonctionne comme n'importe quel autre fournisseur dans Bugbee. Vous vous abonnez à Bugbee Go et obtenez votre clé d'API. C'est **totalement facultatif** et vous n'avez pas besoin de l'utiliser pour utiliser Bugbee.
...
Bugbee Go vous donne accès à ces modèles pour **5 $ pour votre premier mois**, puis **10 $/mois**.

---

## Comment ça marche

Bugbee Go fonctionne comme n'importe quel autre fournisseur dans Bugbee.

1. Vous vous connectez à **<a href={console}>Bugbee Zen</a>**, vous vous abonnez à Go et copiez votre clé d'API.
2. Vous exécutez la commande `/connect` dans la TUI, sélectionnez `Bugbee Go` et collez votre clé d'API.
3. Exécutez `/models` dans la TUI pour voir la liste des modèles disponibles via Go.

:::note
Un seul membre par espace de travail peut s'abonner à Bugbee Go.
:::
...
Bugbee Go inclut les limites suivantes :
...
| ----------------- | ----------------- | ------------------------------------------------ | --------------------------- |
| Grok 4.5          | grok-4.5          | `https://github.com/neuralbroker/bugbee/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| GLM-5.2           | glm-5.2           | `https://github.com/neuralbroker/bugbee/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| GLM-5.1           | glm-5.1           | `https://github.com/neuralbroker/bugbee/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| Kimi K3           | kimi-k3           | `https://github.com/neuralbroker/bugbee/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| Kimi K2.7 Code    | kimi-k2.7-code    | `https://github.com/neuralbroker/bugbee/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| Kimi K2.6         | kimi-k2.6         | `https://github.com/neuralbroker/bugbee/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| DeepSeek V4 Pro   | deepseek-v4-pro   | `https://github.com/neuralbroker/bugbee/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| DeepSeek V4 Flash | deepseek-v4-flash | `https://github.com/neuralbroker/bugbee/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiMo-V2.5         | mimo-v2.5         | `https://github.com/neuralbroker/bugbee/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiMo-V2.5-Pro     | mimo-v2.5-pro     | `https://github.com/neuralbroker/bugbee/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiniMax M3        | minimax-m3        | `https://github.com/neuralbroker/bugbee/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| MiniMax M2.7      | minimax-m2.7      | `https://github.com/neuralbroker/bugbee/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| MiniMax M2.5      | minimax-m2.5      | `https://github.com/neuralbroker/bugbee/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| Qwen3.7 Max       | qwen3.7-max       | `https://github.com/neuralbroker/bugbee/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| Qwen3.7 Plus      | qwen3.7-plus      | `https://github.com/neuralbroker/bugbee/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| Qwen3.6 Plus      | qwen3.6-plus      | `https://github.com/neuralbroker/bugbee/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |

L'[ID de modèle](/docs/config/#models) dans votre configuration Bugbee utilise le format `bugbee-go/<model-id>`. Par exemple, pour Kimi K3, vous utiliseriez `bugbee-go/kimi-k3` dans votre configuration.
...
```
https://github.com/neuralbroker/bugbee/zen/go/v1/models
```
...
Nous avons créé Bugbee Go pour :
...
4. N'avoir **aucun verrouillage exclusif** en vous permettant d'utiliser n'importe quel autre fournisseur avec Bugbee également.
