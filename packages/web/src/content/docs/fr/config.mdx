...
Le fichier de configuration a un schéma défini dans [**`bugbee.dev/config.json`**](https://bugbee.dev/config.json).

La configuration TUI utilise [**`bugbee.dev/tui.json`**](https://bugbee.dev/tui.json).
