...
1. Exécutez la commande `/connect` dans le TUI, sélectionnez bugbee et dirigez-vous vers [bugbee.dev/auth](https://github.com/neuralbroker/bugbee/auth).
...
1. Exécutez la commande `/connect` dans le TUI, sélectionnez `Bugbee Go` et rendez-vous sur [bugbee.dev/auth](https://github.com/neuralbroker/bugbee/zen).
