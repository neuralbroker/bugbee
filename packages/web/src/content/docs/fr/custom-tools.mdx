...
description: Créez des outils que le LLM peut appeler dans bugbee.
---

Les outils personnalisés sont des fonctions que vous créez et que le LLM peut appeler pendant les conversations. Ils fonctionnent avec les [outils intégrés](/docs/tools) de bugbee comme `read`, `write` et `bash`.
...
- Localement en les plaçant dans le répertoire `.bugbee/tools/` de votre projet.
- Ou globalement, en les plaçant dans `~/.config/bugbee/tools/`.
