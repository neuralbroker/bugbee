---
title: SDK
description: bugbee sunucusu için type-safe JS istemcisi.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

bugbee JS/TS SDK, sunucu ile etkileşmek için type-safe bir istemci sağlar.
bugbee'u programatik olarak kontrol etmek ve entegrasyonlar oluşturmak için kullanabilirsiniz.
...
Davranışı özelleştirmek için bir yapılandırma nesnesi iletebilirsiniz. Örnek yine de `bugbee.json` dosyanızı alır, ancak yapılandırmayı satır içi olarak geçersiz kılabilir veya ekleyebilirsiniz:
...
Halihazırda çalışan bir bugbee örneğiniz varsa, ona bağlanmak için bir istemci örneği oluşturabilirsiniz:
