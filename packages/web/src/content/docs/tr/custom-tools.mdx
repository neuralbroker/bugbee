---
title: Özel Araçlar
description: LLM'un bugbee'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. bugbee'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.bugbee/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/bugbee/tools/` içine yerleştirerek.
