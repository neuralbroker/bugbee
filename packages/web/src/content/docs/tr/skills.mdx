...
Ajan becerileri, bugbee'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
bugbee su konumlari tarar:

- Proje konfigurasyonu: `.bugbee/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/bugbee/skills/<name>/SKILL.md`
...
Proje yerel yollarinda bugbee, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.bugbee/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/bugbee/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.bugbee/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
bugbee, `skill` araci aciklamasinda mevcut becerileri listeler.
...
`bugbee.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`bugbee.json` icinde):
