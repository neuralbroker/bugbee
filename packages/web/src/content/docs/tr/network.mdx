...
bugbee, kurumsal ağ ortamları için standart proxy ortam değişkenlerini ve özel sertifikaları destekler.

---

## Vekil Sunucu

bugbee respects standard proxy environment variables.
...
Kuruluşunuz HTTPS bağlantıları için özel CA'lar kullanıyorsa, bugbee'u bunlara güvenecek şekilde yapılandırın.
