---
title: Paylasim
description: bugbee konusmalarini genel baglantilarla paylasin.
---

bugbee'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda bugbee:
...
bugbee, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak bugbee manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `bugbee.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda bugbee kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
