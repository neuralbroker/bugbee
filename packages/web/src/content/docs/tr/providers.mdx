...
1. TUI'de `/connect` komutunu çalıştırın, bugbee'u seçin ve [bugbee.dev/auth](https://github.com/neuralbroker/bugbee/auth)'ye gidin.
...
1. TUI'de `/connect` komutunu çalıştırın, `Bugbee Go`'yu seçin ve [bugbee.dev/auth](https://github.com/neuralbroker/bugbee/zen) adresine gidin.
