...
`.bugbee/commands/test.md` oluştur:
...
bugbee işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

bugbee [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/bugbee/commands/`
- Proje başına: `.bugbee/commands/`
...
bugbee, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
