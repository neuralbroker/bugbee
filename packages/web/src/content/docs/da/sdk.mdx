...
Brug den til at bygge integrasjoner og kontrollere bugbee programmatisk.
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `bugbee.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av bugbee, kan du oprete en klientforekomst for at koble til den:
