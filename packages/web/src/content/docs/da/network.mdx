...
Bugbee understøtter standard proxymiljøvariabler og brugerdefinerede certifikater til virksomhedsnetværksmiljøer.

---

## Proxy

Bugbee respekterer standard proxy-miljøvariabler.
...
Hvis din virksomhed bruger tilpassede CA'er til HTTPS-forbindelser, skal du konfigurere Bugbee til at stole på dem.
