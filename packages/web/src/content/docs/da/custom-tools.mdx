...
description: Opret værktøjer, som LLM kan kalde bugbee ind.
---

Brugerdefinerede værktøjer er funktioner, du opretter, som LLM kan kalde under samtaler. De arbejder sammen med bugbees [built-in tools](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved at placere dem i biblioteket `.bugbee/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/bugbee/tools/`.
