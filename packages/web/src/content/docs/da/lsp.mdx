---
title: LSP-servere
description: Bugbee integreres med dine LSP-servere.
---

Bugbee kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

Bugbee leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `BUGBEE_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og bugbee åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din bugbee-konfiguration.
