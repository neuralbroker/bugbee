...
Her er alle de innebygde verktøyene som er tilgængelige i Bugbee.
...
:::note
Dette verktøyet er bare tilgængelig når `BUGBEE_EXPERIMENTAL_LSP_TOOL=true` (eller `BUGBEE_EXPERIMENTAL=true`).
:::
...
:::note
Dette verktøyet er bare tilgængelig når du bruger Bugbee-leverandøren eller når miljøvariabelen `BUGBEE_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).
