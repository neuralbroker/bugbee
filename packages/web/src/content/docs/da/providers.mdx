...
1. Kør kommandoen `/connect` i TUI, vælg bugbee og gå til [bugbee.dev/auth](https://github.com/neuralbroker/bugbee/auth).
...
1. Kør kommandoen `/connect` i TUI, vælg `Bugbee Go`, og gå til [bugbee.dev/auth](https://github.com/neuralbroker/bugbee/zen).
