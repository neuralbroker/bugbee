...
Du kan tilføje brugerdefinerede kommandoer gennem Bugbee-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din Bugbee [config](/docs/config):
...
- Globalt: `~/.config/bugbee/commands/`
- Pr. projekt: `.bugbee/commands/`
...
bugbee indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
