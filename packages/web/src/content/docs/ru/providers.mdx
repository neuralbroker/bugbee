...
1. Запустите команду `/connect` в TUI, выберите `Bugbee Zen` и перейдите по адресу [bugbee.dev/auth](https://github.com/neuralbroker/bugbee/zen).
...
1. Запустите команду `/connect` в TUI, выберите `Bugbee Go` и перейдите по адресу [bugbee.dev/auth](https://github.com/neuralbroker/bugbee/zen).
