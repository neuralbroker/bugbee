...
1. Запустите команду `/connect` в TUI, выберите `Bugbee Zen` и перейдите по адресу [bugbee.dev/auth](https://bugbee.dev/auth).
...
1. Запустите команду `/connect` в TUI, выберите `Bugbee Go` и перейдите по адресу [bugbee.dev/auth](https://bugbee.dev/auth).
