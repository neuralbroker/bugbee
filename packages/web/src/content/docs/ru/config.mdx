...
Файл конфигурации имеет схему, определенную в [**`bugbee.dev/config.json`**](https://bugbee.dev/config.json).

Конфигурация TUI использует [**`bugbee.dev/tui.json`**](https://bugbee.dev/tui.json).
