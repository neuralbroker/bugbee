...
Bugbee Go er et lavkostnadsabonnement — **$5 for din første måned**, deretter **$10/måned** — som gir deg pålitelig tilgang til populære åpne kodemodeller.

Go fungerer som enhver annen leverandør i Bugbee. Du abonnerer på Bugbee Go og
...
Bugbee Go gir deg tilgang til disse modellene for **$5 for din første måned**, deretter **$10/måned**.

---

## Hvordan det fungerer

Bugbee Go fungerer som enhver annen leverandør i Bugbee.

1. Du logger inn på **<a href={console}>Bugbee Zen</a>**, abonnerer på Go, og
   kopierer din API-nøkkel.
2. Du kjører kommandoen `/connect` i TUI-en, velger `Bugbee Go`, og limer inn
   din API-nøkkel.
3. Kjør `/models` i TUI-en for å se listen over modeller som er tilgjengelige gjennom Go.

:::note
Kun ett medlem per arbeidsområde kan abonnere på Bugbee Go.
:::
...
Bugbee Go inkluderer følgende grenser:
...
[Modell-ID-en](/docs/config/#models) i din Bugbee-konfigurasjon
bruker formatet `bugbee-go/<model-id>`. For eksempel, for Kimi K3, vil du
bruke `bugbee-go/kimi-k3` i konfigurasjonen din.
...
4. Ha **ingen innelåsing** ved å la deg bruke en hvilken som helst annen leverandør med Bugbee også.
