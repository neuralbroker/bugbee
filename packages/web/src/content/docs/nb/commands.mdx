...
Opprett `.bugbee/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom Bugbee-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i Bugbee [config](/docs/config):
...
Bugbee inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
