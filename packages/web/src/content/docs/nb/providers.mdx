...
1. Kjør kommandoen `/connect` i TUI, velg `Bugbee Zen` og gå til [bugbee.dev/auth](https://bugbee.dev/auth).
...
1. Kjør kommandoen `/connect` i TUI, velg `Bugbee Go`, og gå til [bugbee.dev/auth](https://bugbee.dev/auth).
