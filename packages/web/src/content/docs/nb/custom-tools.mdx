...
description: Lag verktøy som LLM kan kalle inn Bugbee.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med Bugbee sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved å plassere dem i `.bugbee/tools/`-katalogen til prosjektet ditt.
- Eller globalt, ved å plassere dem i `~/.config/bugbee/tools/`.
