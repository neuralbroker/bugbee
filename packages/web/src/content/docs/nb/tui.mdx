---
title: TUI
description: Bruke bugbee-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Bugbee gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre Bugbee starter TUI for gjeldende katalog.
...
Når du bruker Bugbee TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til Bugbee. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt Bugbee. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `bugbee.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge Bugbee venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `bugbee.default`.
