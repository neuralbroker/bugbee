...
import { IconBugbee } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "bugbee/session/message-v2"
import type { Message } from "bugbee/session/message"
import type { Session } from "bugbee/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.bugbee_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.bugbee_name}>
                    <IconBugbee width={16} height={16} />
                  </div>
