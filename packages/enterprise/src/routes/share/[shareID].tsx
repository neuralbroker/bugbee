import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@bugbee-ai/sdk/v2"
import { SessionTurn } from "@bugbee-ai/session-ui/session-turn"
import { SessionReview } from "@bugbee-ai/session-ui/session-review"
import { DataProvider } from "@bugbee-ai/session-ui/context"
import { FileComponentProvider } from "@bugbee-ai/ui/context/file"
import { WorkerPoolProvider } from "@bugbee-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@bugbee-ai/ui/logo"
import { IconButton } from "@bugbee-ai/ui/icon-button"
import { ProviderIcon } from "@bugbee-ai/ui/provider-icon"
import { iife } from "@bugbee-ai/core/util/iife"
import { Binary } from "@bugbee-ai/core/util/binary"
import { NamedError } from "@bugbee-ai/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@bugbee-ai/ui/tabs"
import { MessageNav } from "@bugbee-ai/session-ui/message-nav"
import { FileSSR } from "@bugbee-ai/session-ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@bugbee-ai/session-ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/bugbee-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | Bugbee</Title>
              </Show>
              <Meta name="description" content="bugbee - The AI coding agent built for the terminal." />
