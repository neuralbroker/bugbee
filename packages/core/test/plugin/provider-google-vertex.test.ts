...
import { GoogleVertexPlugin } from "@bugbee-ai/core/plugin/provider/google-vertex"
      ...
      yield* catalog.transform((catalog) =>
        catalog.provider.update(ProviderV2.ID.bugbee, (provider) => {
          provider.api = {
            ...
            url: "https://github.com/neuralbroker/bugbee/zen/v1",
          }
        }),
      )
      yield* addPlugin()

      const provider = required(yield* catalog.provider.get(ProviderV2.ID.bugbee))
