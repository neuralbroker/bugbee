...
import { ProviderPlugins } from "@bugbee-ai/core/plugin/provider"
import { ZenmuxPlugin } from "@bugbee-ai/core/plugin/provider/zenmux"
...
describe("ZenmuxPlugin", () => {
  ...
  it.effect("applies the exact legacy Zenmux headers", () =>
    Effect.gen(function* () {
      ...
      expect(result.request.headers).toEqual({ "HTTP-Referer": "https://github.com/neuralbroker/bugbee/", "X-Title": "bugbee" })
