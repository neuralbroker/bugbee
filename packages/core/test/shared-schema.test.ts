...
import { AgentAttachment, FileAttachment, Prompt, Source } from "@bugbee-ai/schema/prompt"
import { Provider } from "@bugbee-ai/schema/provider"
import { Project } from "@bugbee-ai/schema/project"
import { ProjectDirectories } from "@bugbee-ai/schema/project-directories"
import { PermissionV1 } from "@bugbee-ai/schema/permission-v1"
...
import { Command } from "@bugbee-ai/schema/command"
import { Connection } from "@bugbee-ai/schema/connection"
import { Credential } from "@bugbee-ai/schema/credential"
import { FileSystem } from "@bugbee-ai/schema/filesystem"
import { Integration } from "@bugbee-ai/schema/integration"
import { LLM } from "@bugbee-ai/schema/llm"
import { Permission } from "@bugbee-ai/schema/permission"
import { Plugin } from "@bugbee-ai/schema/plugin"
import { Pty } from "@bugbee-ai/schema/pty"
import { Reference } from "@bugbee-ai/schema/reference"
import { SessionTodo } from "@bugbee-ai/schema/session-todo"
import { Skill } from "@bugbee-ai/schema/skill"
import { AbsolutePath, DateTimeUtcFromMillis, optional, statics } from "@bugbee-ai/schema/schema"
...
test("Core reuses the canonical shared schemas", async () => {
  const [
    ...
    import("@bugbee-ai/core/command"),
    import("@bugbee-ai/core/integration/connection"),
    import("@bugbee-ai/core/credential"),
    import("@bugbee-ai/core/filesystem"),
    import("@bugbee-ai/core/integration"),
    import("@bugbee-ai/core/location"),
    import("@bugbee-ai/llm"),
    import("@bugbee-ai/core/permission"),
    import("@bugbee-ai/core/v1/permission"),
    import("@bugbee-ai/core/project/copy"),
    import("@bugbee-ai/core/pty"),
    import("@bugbee-ai/core/project/schema"),
    import("@bugbee-ai/core/reference"),
    import("@bugbee-ai/core/session/input"),
    import("@bugbee-ai/core/session/message"),
    import("@bugbee-ai/core/session/todo"),
    import("@bugbee-ai/core/session/prompt"),
    import("@bugbee-ai/core/skill"),
    import("@bugbee-ai/core/v2-schema"),
    import("@bugbee-ai/core/schema"),
    import("@bugbee-ai/core/workspace"),
  ])
