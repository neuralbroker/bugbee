...
import { Entry, FileSystem, FindInput, Match } from "@bugbee-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@bugbee-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@bugbee/v2/FileSystem") {}
