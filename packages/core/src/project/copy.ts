...
import { Event } from "@bugbee-ai/schema/project-directories"
import { ProjectCopy } from "@bugbee-ai/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@bugbee/ProjectCopy") {}
