...
import type { EffectDrizzleSqlite } from "@bugbee-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@bugbee/ProjectDirectories") {}
