...
import type { Data, Definition, Payload } from "@bugbee-ai/schema/event"
...
import { Durable } from "@bugbee-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@bugbee-ai/schema/event").ID
export type { Data, Definition, Payload } from "@bugbee-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@bugbee/Event") {}
