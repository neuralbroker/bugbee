...
import { ListAnchor } from "@bugbee-ai/schema/session"
...
import { SessionDurable } from "@bugbee-ai/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@bugbee/v2/Session") {}
