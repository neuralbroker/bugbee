...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@bugbee-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@bugbee/v2/ToolRegistry") {}
