...
import { Catalog } from "@bugbee-ai/schema/catalog"
...
export class Service extends Context.Service<Service, Interface>()("@bugbee/v2/Catalog") {}
    ...
    const result: Interface = {
      ...
      model: {
        ...
        small: Effect.fn("CatalogV2.model.small")(function* (providerID) {
          ...
          if (providerID === ProviderV2.ID.bugbee) {
