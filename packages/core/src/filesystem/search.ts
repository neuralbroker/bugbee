...
export class Service extends Context.Service<Service, Interface>()("@bugbee/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.BUGBEE_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
