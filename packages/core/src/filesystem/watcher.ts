...
import { FileSystemWatcher } from "@bugbee-ai/schema/filesystem-watcher"
...
declare const BUGBEE_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof BUGBEE_LIBC === "undefined" ? undefined : BUGBEE_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@bugbee/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.BUGBEE_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.BUGBEE_EXPERIMENTAL_FILEWATCHER)) {
