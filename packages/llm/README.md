...
Schema-first LLM core for bugbee. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@bugbee-ai/llm"
import { OpenAI } from "@bugbee-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@bugbee-ai/llm/providers"
