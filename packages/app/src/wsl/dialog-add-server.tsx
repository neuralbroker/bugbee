...
import { showToast } from "@bugbee-ai/ui/toast"
import { ButtonV2 } from "@bugbee-ai/ui/v2/button-v2"
import { Dialog, DialogBody, DialogFooter, DialogHeader, DialogTitle } from "@bugbee-ai/ui/v2/dialog-v2"
import { DividerV2 } from "@bugbee-ai/ui/v2/divider-v2"
import { LoaderV2 } from "@bugbee-ai/ui/v2/loader-v2"
import { RadioGroupV2, RadioItemV2 } from "@bugbee-ai/ui/v2/radio-v2"
...
function useWslAddServerController(props: DialogWslServerProps) {
  ...
  const runPrimary = async () => {
    ...
    if (action === "install-bugbee") {
      await run(() => api.installBugbee(distro))
      return
    }
