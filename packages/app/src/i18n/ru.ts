export const dict = {
  ...
  "dialog.provider.bugbee.note": "Отобранные модели, включая Claude, GPT, Gemini и другие",
  "dialog.provider.bugbee.tagline": "Надежные оптимизированные модели",
  "dialog.provider.bugbeeGo.tagline": "Доступная подписка для всех",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от Bugbee",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в Bugbee.",
  ...
  "provider.connect.bugbeeZen.line1":
    "Bugbee Zen даёт вам доступ к отобранным надёжным оптимизированным моделям для агентов программирования.",
  "provider.connect.bugbeeZen.line2":
    "С одним API ключом вы получите доступ к таким моделям как Claude, GPT, Gemini, GLM и другим.",
  "provider.connect.bugbeeZen.visit.prefix": "Посетите ",
  "provider.connect.bugbeeZen.visit.link": "bugbee.dev/zen",
  "provider.connect.bugbeeZen.visit.suffix": " чтобы получить ваш API ключ.",
  "provider.connect.oauth.code.visit.prefix": "Посетите ",
  "provider.connect.oauth.code.visit.link": "эту ссылку",
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в Bugbee.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в Bugbee.",
  ...
  "dialog.plugins.empty": "Плагины настроены в bugbee.json",
  ...
  "dialog.server.description": "Переключите сервер Bugbee к которому подключается приложение.",
  ...
  "wsl.onboarding.checkingBugbee": "Проверка Bugbee...",
  "wsl.onboarding.checkingBugbeeIn": "Проверка Bugbee в {{distro}}...",
  "wsl.onboarding.updatingBugbee": "Обновление Bugbee...",
  "wsl.onboarding.updatingBugbeeIn": "Обновление Bugbee в {{distro}}...",
  "wsl.onboarding.updateBugbeeIn": "Обновите Bugbee в {{distro}}.",
  "wsl.onboarding.updateBugbee": "Обновить Bugbee",
  "wsl.onboarding.bugbeeReadyIn": "Bugbee в {{distro}} готов к работе.",
  "wsl.onboarding.bugbeeReady": "Bugbee готов к работе.",
  "wsl.onboarding.installBugbeeIn": "Установите Bugbee в {{distro}}.",
  "wsl.onboarding.installBugbee": "Установить Bugbee",
  ...
  "wsl.onboarding.distroStatus.bugbeeMissing": "Bugbee не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в Bugbee требуется WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Bugbee не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте Bugbee.",
  ...
  "toast.update.description": "Новая версия Bugbee ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде Bugbee",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера/модели в конфиге (bugbee.json)",
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что Bugbee пока не поддерживает MCP авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "Bugbee включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер Bugbee внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения Bugbee",
  ...
  "settings.general.row.appearance.description": "Настройте как Bugbee выглядит на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли Bugbee системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление Bugbee.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске Bugbee",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию Bugbee.",
