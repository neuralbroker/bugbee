export const dict = {
  ...
  "dialog.provider.bugbee.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.bugbee.tagline": "Modelos optimizados y fiables",
  "dialog.provider.bugbeeGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Bugbee",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Bugbee.",
  ...
  "provider.connect.bugbeeZen.line1":
    "Bugbee Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.bugbeeZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.bugbeeZen.visit.prefix": "Visita ",
  "provider.connect.bugbeeZen.visit.link": "bugbee.dev/zen",
  "provider.connect.bugbeeZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Bugbee.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Bugbee.",
  ...
  "dialog.plugins.empty": "Plugins configurados en bugbee.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Bugbee se conecta esta app.",
  ...
  "wsl.onboarding.checkingBugbee": "Comprobando Bugbee...",
  "wsl.onboarding.checkingBugbeeIn": "Comprobando Bugbee en {{distro}}...",
  "wsl.onboarding.updatingBugbee": "Actualizando Bugbee...",
  "wsl.onboarding.updatingBugbeeIn": "Actualizando Bugbee en {{distro}}...",
  "wsl.onboarding.updateBugbeeIn": "Actualiza Bugbee en {{distro}}.",
  "wsl.onboarding.updateBugbee": "Actualizar Bugbee",
  "wsl.onboarding.bugbeeReadyIn": "Bugbee está listo en {{distro}}.",
  "wsl.onboarding.bugbeeReady": "Bugbee está listo.",
  "wsl.onboarding.installBugbeeIn": "Instala Bugbee en {{distro}}.",
  "wsl.onboarding.installBugbee": "Instalar Bugbee",
  ...
  "wsl.onboarding.distroStatus.bugbeeMissing": "Bugbee no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Bugbee pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Bugbee no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Bugbee.",
  ...
  "toast.update.description": "Una nueva versión de Bugbee ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Bugbee",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (bugbee.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Bugbee no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Bugbee incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Bugbee dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Bugbee",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Bugbee en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Bugbee sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Bugbee.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Bugbee",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Bugbee.",
