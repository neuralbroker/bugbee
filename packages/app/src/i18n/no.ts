...
export const dict = {
  ...
  "dialog.provider.bugbee.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.bugbee.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.bugbeeGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Bugbee",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Bugbee.",
  ...
  "provider.connect.bugbeeZen.line1":
    "Bugbee Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.bugbeeZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.bugbeeZen.visit.prefix": "Besøk ",
  "provider.connect.bugbeeZen.visit.link": "bugbee.dev/zen",
  "provider.connect.bugbeeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Bugbee.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Bugbee.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i bugbee.json",
  ...
  "dialog.server.description": "Bytt hvilken Bugbee-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Bugbee ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Bugbee-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (bugbee.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Bugbee ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Bugbee inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Bugbee-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Bugbee",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Bugbee ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Bugbee skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Bugbee er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Bugbee starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Bugbee.",
  ...
  "wsl.onboarding.checkingBugbee": "Sjekker Bugbee...",
  "wsl.onboarding.checkingBugbeeIn": "Sjekker Bugbee i {{distro}}...",
  "wsl.onboarding.updatingBugbee": "Oppdaterer Bugbee...",
  "wsl.onboarding.updatingBugbeeIn": "Oppdaterer Bugbee i {{distro}}...",
  "wsl.onboarding.updateBugbeeIn": "Oppdater Bugbee i {{distro}}.",
  "wsl.onboarding.updateBugbee": "Oppdater Bugbee",
  "wsl.onboarding.bugbeeReadyIn": "Bugbee er klar i {{distro}}.",
  "wsl.onboarding.bugbeeReady": "Bugbee er klar.",
  "wsl.onboarding.installBugbeeIn": "Installer Bugbee i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.bugbeeMissing": "Bugbee er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Bugbee kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Bugbee kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Bugbee på nytt.",
