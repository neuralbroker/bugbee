export const dict = {
  ...
  "dialog.provider.bugbee.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.bugbee.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.bugbeeGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Bugbee",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Bugbee.",
  ...
  "provider.connect.bugbeeZen.line1":
    "يمنحك Bugbee Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.bugbeeZen.visit.prefix": "قم بزيارة ",
  "provider.connect.bugbeeZen.visit.link": "bugbee.dev/zen",
  "provider.connect.bugbeeZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Bugbee.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Bugbee.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في bugbee.json",
  ...
  "dialog.server.description": "تبديل خادم Bugbee الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingBugbee": "جارٍ التحقق من Bugbee...",
  "wsl.onboarding.checkingBugbeeIn": "جارٍ التحقق من Bugbee في {{distro}}...",
  "wsl.onboarding.updatingBugbee": "جارٍ تحديث Bugbee...",
  "wsl.onboarding.updatingBugbeeIn": "جارٍ تحديث Bugbee في {{distro}}...",
  "wsl.onboarding.updateBugbeeIn": "حدّث Bugbee في {{distro}}.",
  "wsl.onboarding.updateBugbee": "تحديث Bugbee",
  "wsl.onboarding.bugbeeReadyIn": "Bugbee جاهز في {{distro}}.",
  "wsl.onboarding.bugbeeReady": "Bugbee جاهز.",
  "wsl.onboarding.installBugbeeIn": "ثبّت Bugbee في {{distro}}.",
  "wsl.onboarding.installBugbee": "تثبيت Bugbee",
  ...
  "wsl.onboarding.distroStatus.bugbeeMissing": "Bugbee غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Bugbee من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Bugbee التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Bugbee.",
  ...
  "toast.update.description": "نسخة جديدة من Bugbee ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Bugbee",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (bugbee.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Bugbee لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Bugbee نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Bugbee داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Bugbee",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Bugbee على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Bugbee يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Bugbee.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Bugbee",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Bugbee.",
