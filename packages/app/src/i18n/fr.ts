export const dict = {
  ...
  "dialog.provider.bugbee.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.bugbee.tagline": "Modèles optimisés et fiables",
  "dialog.provider.bugbeeGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Bugbee",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Bugbee.",
  ...
  "provider.connect.bugbeeZen.line1":
    "Bugbee Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.bugbeeZen.visit.prefix": "Visitez ",
  "provider.connect.bugbeeZen.visit.link": "bugbee.dev/zen",
  "provider.connect.bugbeeZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Bugbee.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Bugbee.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans bugbee.json",
  ...
  "dialog.server.description": "Changez le serveur Bugbee auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingBugbee": "Vérification d'Bugbee...",
  "wsl.onboarding.checkingBugbeeIn": "Vérification d'Bugbee dans {{distro}}...",
  "wsl.onboarding.updatingBugbee": "Mise à jour d'Bugbee...",
  "wsl.onboarding.updatingBugbeeIn": "Mise à jour d'Bugbee dans {{distro}}...",
  "wsl.onboarding.updateBugbeeIn": "Mettez à jour Bugbee dans {{distro}}.",
  "wsl.onboarding.updateBugbee": "Mettre à jour Bugbee",
  "wsl.onboarding.bugbeeReadyIn": "Bugbee est prêt dans {{distro}}.",
  "wsl.onboarding.bugbeeReady": "Bugbee est prêt.",
  "wsl.onboarding.installBugbeeIn": "Installez Bugbee dans {{distro}}.",
  "wsl.onboarding.installBugbee": "Installer Bugbee",
  ...
  "wsl.onboarding.distroStatus.bugbeeMissing": "Bugbee non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Bugbee puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Bugbee n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Bugbee.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Bugbee ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Bugbee",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (bugbee.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Bugbee ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Bugbee inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Bugbee dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Bugbee",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Bugbee sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Bugbee suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Bugbee.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Bugbee",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Bugbee.",
