export const dict = {
  ...
  "dialog.provider.bugbee.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.bugbee.tagline": "Reliable optimized models",
  "dialog.provider.bugbeeGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Bugbee",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Bugbee.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.bugbeeZen.line1":
    "Bugbee Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.bugbeeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.bugbeeZen.visit.prefix": "Visit ",
  "provider.connect.bugbeeZen.visit.link": "bugbee.dev/zen",
  "provider.connect.bugbeeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Bugbee.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Bugbee.",
  ...
  "dialog.plugins.empty": "Plugins configured in bugbee.json",
  ...
  "dialog.server.description": "Switch which Bugbee server this app connects to.",
  ...
  "wsl.onboarding.checkingBugbee": "Checking Bugbee...",
  "wsl.onboarding.checkingBugbeeIn": "Checking Bugbee in {{distro}}...",
  "wsl.onboarding.updatingBugbee": "Updating Bugbee...",
  "wsl.onboarding.updatingBugbeeIn": "Updating Bugbee in {{distro}}...",
  "wsl.onboarding.updateBugbeeIn": "Update Bugbee in {{distro}}.",
  "wsl.onboarding.updateBugbee": "Update Bugbee",
  "wsl.onboarding.bugbeeReadyIn": "Bugbee is ready in {{distro}}.",
  "wsl.onboarding.bugbeeReady": "Bugbee is ready.",
  "wsl.onboarding.installBugbeeIn": "Install Bugbee in {{distro}}.",
  "wsl.onboarding.installBugbee": "Install Bugbee",
  ...
  "wsl.onboarding.distroStatus.bugbeeMissing": "Bugbee not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Bugbee can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Bugbee could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Bugbee.",
  ...
  "toast.update.description": "A new version of Bugbee ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Bugbee team",
  ...
  "error.chain.checkConfig": "Check your config (bugbee.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Bugbee does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Bugbee includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Bugbee server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Bugbee",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Bugbee looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Bugbee follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Bugbee is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Bugbee launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Bugbee.",
