...
export const dict = {
  ...
  "dialog.provider.bugbee.note": "使用 Bugbee Zen 或 API 密钥连接",
  "dialog.provider.bugbee.tagline": "可靠的优化模型",
  "dialog.provider.bugbeeGo.tagline": "适合所有人的低成本订阅",
  ...
  "dialog.model.unpaid.freeModels.title": "Bugbee 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 Bugbee 中使用 {{provider}} 模型。",
  ...
  "provider.connect.bugbeeZen.line1": "Bugbee Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.bugbeeZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.bugbeeZen.visit.prefix": "访问 ",
  "provider.connect.bugbeeZen.visit.link": "bugbee.dev/zen",
  "provider.connect.bugbeeZen.visit.suffix": " 获取你的 API 密钥。",
  "provider.connect.oauth.code.visit.prefix": "访问 ",
  "provider.connect.oauth.code.visit.link": "此链接",
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 Bugbee 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 Bugbee 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 bugbee.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 Bugbee 服务器。",
  ...
  "wsl.onboarding.checkingBugbee": "正在检查 Bugbee...",
  "wsl.onboarding.checkingBugbeeIn": "正在检查 {{distro}} 中的 Bugbee...",
  "wsl.onboarding.updatingBugbee": "正在更新 Bugbee...",
  "wsl.onboarding.updatingBugbeeIn": "正在更新 {{distro}} 中的 Bugbee...",
  "wsl.onboarding.updateBugbeeIn": "更新 {{distro}} 中的 Bugbee。",
  "wsl.onboarding.updateBugbee": "更新 Bugbee",
  "wsl.onboarding.bugbeeReadyIn": "{{distro}} 中的 Bugbee 已就绪。",
  "wsl.onboarding.bugbeeReady": "Bugbee 已就绪。",
  "wsl.onboarding.installBugbeeIn": "在 {{distro}} 中安装 Bugbee。",
  "wsl.onboarding.installBugbee": "安装 Bugbee",
  ...
  "wsl.onboarding.distroStatus.bugbeeMissing": "未安装 Bugbee",
  ...
  "wsl.onboarding.wslNotInstalled.description": "Bugbee 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "Bugbee 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 Bugbee。",
  ...
  "toast.update.description": "Bugbee 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Bugbee 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (bugbee.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: Bugbee 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Bugbee 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Bugbee 服务器。",
  ...
  "settings.general.row.language.description": "更改 Bugbee 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 Bugbee 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Bugbee 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Bugbee 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Bugbee 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Bugbee。",
