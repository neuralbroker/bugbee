...
export const dict = {
  ...
  "dialog.provider.bugbee.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.bugbee.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.bugbeeGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Bugbee tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Bugbee'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.bugbeeZen.line1":
    "Bugbee Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.bugbeeZen.visit.prefix": "",
  "provider.connect.bugbeeZen.visit.link": "bugbee.dev/zen",
  "provider.connect.bugbeeZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Bugbee'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Bugbee'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler bugbee.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Bugbee sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingBugbee": "Bugbee kontrol ediliyor...",
  "wsl.onboarding.checkingBugbeeIn": "{{distro}} içinde Bugbee kontrol ediliyor...",
  "wsl.onboarding.updatingBugbee": "Bugbee güncelleniyor...",
  "wsl.onboarding.updatingBugbeeIn": "{{distro}} içinde Bugbee güncelleniyor...",
  "wsl.onboarding.updateBugbeeIn": "{{distro}} içindeki Bugbee'u güncelleyin.",
  "wsl.onboarding.updateBugbee": "Bugbee'u güncelle",
  "wsl.onboarding.bugbeeReadyIn": "{{distro}} içinde Bugbee hazır.",
  "wsl.onboarding.bugbeeReady": "Bugbee hazır.",
  "wsl.onboarding.installBugbeeIn": "Bugbee'u {{distro}} içine kurun.",
  "wsl.onboarding.installBugbee": "Bugbee'u kur",
  ...
  "wsl.onboarding.distroStatus.bugbeeMissing": "Bugbee kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Bugbee'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Bugbee bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Bugbee'u tekrar açın.",
  ...
  "toast.update.description": "Bugbee'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Bugbee ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (bugbee.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Bugbee henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Bugbee ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Bugbee Masaüstü",
  ...
  "settings.desktop.wsl.description": "Bugbee sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Bugbee'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Bugbee'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Bugbee'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Bugbee'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Bugbee başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Bugbee'un en son sürümünü kullanıyorsunuz.",
