export const dict = {
  ...
  "dialog.provider.bugbee.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.bugbee.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.bugbeeGo.tagline": "Недорога підписка для всіх",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від Bugbee",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у Bugbee.",
  ...
  "provider.connect.bugbeeZen.line1":
    "Bugbee Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.bugbeeZen.visit.prefix": "Відвідайте ",
  "provider.connect.bugbeeZen.visit.link": "bugbee.dev/zen",
  "provider.connect.bugbeeZen.visit.suffix": ", щоб отримати ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Відвідайте ",
  "provider.connect.oauth.code.visit.link": "це посилання",
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у Bugbee.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у Bugbee.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в bugbee.json",
  ...
  "dialog.server.description": "Перемкніть сервер Bugbee, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingBugbee": "Перевірка Bugbee...",
  "wsl.onboarding.checkingBugbeeIn": "Перевірка Bugbee у {{distro}}...",
  "wsl.onboarding.updatingBugbee": "Оновлення Bugbee...",
  "wsl.onboarding.updatingBugbeeIn": "Оновлення Bugbee у {{distro}}...",
  "wsl.onboarding.updateBugbeeIn": "Оновіть Bugbee у {{distro}}.",
  "wsl.onboarding.updateBugbee": "Оновити Bugbee",
  "wsl.onboarding.bugbeeReadyIn": "Bugbee готовий до роботи у {{distro}}.",
  "wsl.onboarding.bugbeeReady": "Bugbee готовий до роботи.",
  "wsl.onboarding.installBugbeeIn": "Встановіть Bugbee у {{distro}}.",
  "wsl.onboarding.installBugbee": "Встановити Bugbee",
  ...
  "wsl.onboarding.distroStatus.bugbeeMissing": "Bugbee не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в Bugbee потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Bugbee не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте Bugbee.",
  ...
  "toast.update.description": "Нова версія Bugbee ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді Bugbee",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (bugbee.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, Bugbee ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "Bugbee містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер Bugbee всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу Bugbee",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд Bugbee на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи Bugbee використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему Bugbee.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску Bugbee",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію Bugbee.",
