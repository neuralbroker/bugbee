export const dict = {
  ...
  "dialog.provider.bugbee.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.bugbee.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.bugbeeGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "Bugbeeが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Bugbeeで{{provider}}モデルを使用します。",
  ...
  "provider.connect.bugbeeZen.line1":
    "Bugbee Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.bugbeeZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.bugbeeZen.visit.prefix": " ",
  "provider.connect.bugbeeZen.visit.link": "bugbee.dev/zen",
  "provider.connect.bugbeeZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してBugbeeで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Bugbeeで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "bugbee.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するBugbeeサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingBugbee": "Bugbeeを確認中...",
  "wsl.onboarding.checkingBugbeeIn": "{{distro}}内のBugbeeを確認中...",
  "wsl.onboarding.updatingBugbee": "Bugbeeを更新中...",
  "wsl.onboarding.updatingBugbeeIn": "{{distro}}内のBugbeeを更新中...",
  "wsl.onboarding.updateBugbeeIn": "{{distro}}内のBugbeeを更新してください。",
  "wsl.onboarding.updateBugbee": "Bugbeeを更新",
  "wsl.onboarding.bugbeeReadyIn": "{{distro}}内のBugbeeの準備ができました。",
  "wsl.onboarding.bugbeeReady": "Bugbeeの準備ができました。",
  "wsl.onboarding.installBugbeeIn": "{{distro}}にBugbeeをインストールしてください。",
  "wsl.onboarding.installBugbee": "Bugbeeをインストール",
  ...
  "wsl.onboarding.distroStatus.bugbeeMissing": "Bugbeeがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "BugbeeでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Bugbeeをもう一度開いてください。",
  ...
  "toast.update.description": "Bugbeeの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをBugbeeチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (bugbee.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: BugbeeはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Bugbeeには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でBugbeeサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Bugbeeの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのBugbeeの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Bugbeeがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Bugbeeのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Bugbee の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Bugbee は最新バージョンです。",
