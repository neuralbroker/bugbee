export const dict = {
  ...
  "dialog.provider.bugbee.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.bugbee.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.bugbeeGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Bugbee",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Bugbee-u.",
  ...
  "provider.connect.bugbeeZen.line1":
    "Bugbee Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.bugbeeZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.bugbeeZen.visit.prefix": "Posjeti ",
  "provider.connect.bugbeeZen.visit.link": "bugbee.dev/zen",
  "provider.connect.bugbeeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Bugbee-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Bugbee-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u bugbee.json",
  ...
  "dialog.server.description": "Promijeni na koji se Bugbee server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingBugbee": "Provjera Bugbee...",
  "wsl.onboarding.checkingBugbeeIn": "Provjera Bugbee u distribuciji {{distro}}...",
  "wsl.onboarding.updatingBugbee": "Ažuriranje Bugbee...",
  "wsl.onboarding.updatingBugbeeIn": "Ažuriranje Bugbee u distribuciji {{distro}}...",
  "wsl.onboarding.updateBugbeeIn": "Ažuriraj Bugbee u distribuciji {{distro}}.",
  "wsl.onboarding.updateBugbee": "Ažuriraj Bugbee",
  "wsl.onboarding.bugbeeReadyIn": "Bugbee je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.bugbeeReady": "Bugbee je spreman.",
  "wsl.onboarding.installBugbeeIn": "Instaliraj Bugbee u distribuciji {{distro}}.",
  "wsl.onboarding.installBugbee": "Instaliraj Bugbee",
  ...
  "wsl.onboarding.distroStatus.bugbeeMissing": "Bugbee nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Bugbee mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Bugbee nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Bugbee.",
  ...
  "toast.update.description": "Nova verzija Bugbee-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Bugbee timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (bugbee.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Bugbee još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Bugbee uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Bugbee server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Bugbee-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Bugbee izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Bugbee prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Bugbee-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Bugbee pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Bugbee-a.",
