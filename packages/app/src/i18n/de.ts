...
export const dict = {
  ...
  "dialog.provider.bugbee.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.bugbee.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.bugbeeGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Bugbee",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Bugbee zu nutzen.",
  ...
  "provider.connect.bugbeeZen.line1":
    "Bugbee Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  "provider.connect.bugbeeZen.line2":
    "Mit einem einzigen API-Schlüssel erhalten Sie Zugriff auf Modelle wie Claude, GPT, Gemini, GLM und mehr.",
  "provider.connect.bugbeeZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.bugbeeZen.visit.link": "bugbee.dev/zen",
  "provider.connect.bugbeeZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Bugbee zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Bugbee zu nutzen.",
  ...
  "dialog.plugins.empty": "In bugbee.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Bugbee-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.bugbee": "Bugbee",
  ...
  "wsl.onboarding.checkingBugbee": "Bugbee wird geprüft...",
  "wsl.onboarding.checkingBugbeeIn": "Bugbee in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingBugbee": "Bugbee wird aktualisiert...",
  "wsl.onboarding.updatingBugbeeIn": "Bugbee in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateBugbeeIn": "Aktualisieren Sie Bugbee in {{distro}}.",
  "wsl.onboarding.updateBugbee": "Bugbee aktualisieren",
  "wsl.onboarding.bugbeeReadyIn": "Bugbee ist in {{distro}} bereit.",
  "wsl.onboarding.bugbeeReady": "Bugbee ist bereit.",
  "wsl.onboarding.installBugbeeIn": "Installieren Sie Bugbee in {{distro}}.",
  "wsl.onboarding.installBugbee": "Bugbee installieren",
  ...
  "wsl.onboarding.distroStatus.bugbeeMissing": "Bugbee nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Bugbee einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Bugbee konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Bugbee erneut.",
  ...
  "toast.update.description": "Eine neue Version von Bugbee ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Bugbee-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (bugbee.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Bugbee unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Bugbee enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "Bugbee Desktop",
  ...
  "settings.desktop.wsl.description": "Bugbee-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Bugbee ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Bugbee auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Bugbee dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Bugbee anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Bugbee automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Bugbee.",
