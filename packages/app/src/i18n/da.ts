export const dict = {
  ...
  "dialog.provider.bugbee.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.bugbee.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.bugbeeGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Bugbee",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Bugbee.",
  ...
  "provider.connect.bugbeeZen.line1":
    "Bugbee Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.bugbeeZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.bugbeeZen.visit.prefix": "Besøg ",
  "provider.connect.bugbeeZen.visit.link": "bugbee.dev/zen",
  "provider.connect.bugbeeZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Bugbee.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Bugbee.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i bugbee.json",
  ...
  "dialog.server.description": "Skift hvilken Bugbee-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingBugbee": "Tjekker Bugbee...",
  "wsl.onboarding.checkingBugbeeIn": "Tjekker Bugbee i {{distro}}...",
  "wsl.onboarding.updatingBugbee": "Opdaterer Bugbee...",
  "wsl.onboarding.updatingBugbeeIn": "Opdaterer Bugbee i {{distro}}...",
  "wsl.onboarding.updateBugbeeIn": "Opdater Bugbee i {{distro}}.",
  "wsl.onboarding.updateBugbee": "Opdater Bugbee",
  ...
  "wsl.onboarding.distroStatus.bugbeeMissing": "Bugbee er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Bugbee kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Bugbee kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Bugbee igen.",
  ...
  "toast.update.description": "En ny version af Bugbee ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Bugbee-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (bugbee.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Bugbee understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Bugbee inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Bugbee-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Bugbee",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Bugbee ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om Bugbee følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Bugbee er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Bugbee starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Bugbee.",
