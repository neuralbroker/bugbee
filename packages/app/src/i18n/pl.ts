export const dict = {
  ...
  "dialog.provider.bugbee.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.bugbee.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.bugbeeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Bugbee",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Bugbee.",
  ...
  "provider.connect.bugbeeZen.line1":
    "Bugbee Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  "provider.connect.bugbeeZen.line2":
    "Z jednym kluczem API uzyskasz dostęp do modeli takich jak Claude, GPT, Gemini, GLM i więcej.",
  "provider.connect.bugbeeZen.visit.prefix": "Odwiedź ",
  "provider.connect.bugbeeZen.visit.link": "bugbee.dev/zen",
  "provider.connect.bugbeeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Bugbee.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Bugbee.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w bugbee.json",
  ...
  "dialog.server.description": "Przełącz serwer Bugbee, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingBugbee": "Sprawdzanie Bugbee...",
  "wsl.onboarding.checkingBugbeeIn": "Sprawdzanie Bugbee w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingBugbee": "Aktualizowanie Bugbee...",
  "wsl.onboarding.updatingBugbeeIn": "Aktualizowanie Bugbee w dystrybucji {{distro}}...",
  "wsl.onboarding.updateBugbeeIn": "Zaktualizuj Bugbee w dystrybucji {{distro}}.",
  "wsl.onboarding.updateBugbee": "Zaktualizuj Bugbee",
  "wsl.onboarding.bugbeeReadyIn": "Bugbee jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.bugbeeReady": "Bugbee jest gotowy.",
  "wsl.onboarding.installBugbeeIn": "Zainstaluj Bugbee w dystrybucji {{distro}}.",
  "wsl.onboarding.installBugbee": "Zainstaluj Bugbee",
  ...
  "wsl.onboarding.distroStatus.bugbeeMissing": "Bugbee nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Bugbee będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Bugbee nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Bugbee.",
  ...
  "toast.update.description": "Nowa wersja Bugbee ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Bugbee",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (bugbee.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Bugbee nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Bugbee zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Bugbee wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Bugbee",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Bugbee na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Bugbee ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Bugbee.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Bugbee",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Bugbee.",
