export const dict = {
  ...
  "dialog.provider.bugbee.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.bugbee.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.bugbeeGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Bugbee",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Bugbee.",
  ...
  "provider.connect.bugbeeZen.line1":
    "Bugbee Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.bugbeeZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.bugbeeZen.visit.prefix": "Visite ",
  "provider.connect.bugbeeZen.visit.link": "bugbee.dev/zen",
  "provider.connect.bugbeeZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Bugbee.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Bugbee.",
  ...
  "dialog.plugins.empty": "Plugins configurados em bugbee.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Bugbee este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingBugbee": "Verificando o Bugbee...",
  "wsl.onboarding.checkingBugbeeIn": "Verificando o Bugbee em {{distro}}...",
  "wsl.onboarding.updatingBugbee": "Atualizando o Bugbee...",
  "wsl.onboarding.updatingBugbeeIn": "Atualizando o Bugbee em {{distro}}...",
  "wsl.onboarding.updateBugbeeIn": "Atualize o Bugbee em {{distro}}.",
  "wsl.onboarding.updateBugbee": "Atualizar o Bugbee",
  "wsl.onboarding.bugbeeReadyIn": "O Bugbee está pronto em {{distro}}.",
  "wsl.onboarding.bugbeeReady": "O Bugbee está pronto.",
  "wsl.onboarding.installBugbeeIn": "Instale o Bugbee em {{distro}}.",
  "wsl.onboarding.installBugbee": "Instalar o Bugbee",
  ...
  "wsl.onboarding.distroStatus.bugbeeMissing": "Bugbee não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Bugbee possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Bugbee não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Bugbee novamente.",
  ...
  "toast.update.description": "Uma nova versão do Bugbee ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Bugbee",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (bugbee.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Bugbee ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Bugbee inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Bugbee dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Bugbee",
  ...
  "settings.general.row.appearance.description": "Personalize como o Bugbee aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Bugbee segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Bugbee é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Bugbee iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Bugbee.",
