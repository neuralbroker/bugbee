...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "bugbee", key: "dialog.provider.bugbee.note" },
  { match: (id: string) => id === "bugbee-go", key: "dialog.provider.bugbeeGo.tagline" },
...
export const SettingsProvidersV2: Component<{ onBack?: () => void }> = (props) => {
  ...
  const connected = createMemo(() => {
    return providers
      .connected()
      .filter((p) => p.id !== "bugbee" || Object.values(p.models).find((m) => m.cost?.input))
  })
                  ...
                  <div class="settings-v2-provider-lead">
                    ...
                    <div class="settings-v2-provider-copy">
                      <div class="settings-v2-provider-main">
                        ...
                        <Show when={item.id === "bugbee" || item.id === "bugbee-go"}>
