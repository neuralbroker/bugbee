...
import { Switch } from "@bugbee-ai/ui/v2/switch-v2"
  ...
  const GeneralSection = () => (
    <div class="settings-v2-section">
      <SettingsListV2>
        ...
        <Show when={mobile() && import.meta.env.VITE_BUGBEE_CHANNEL !== "prod"}>
          <SettingsRowV2
        ...
        <SettingsRowV2
          ...
          description={
            <>
              ...
              <Link class="settings-v2-link" href="https://bugbee.dev/docs/themes/">
