...
beforeAll(async () => {
  ...
  mock.module("@bugbee-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@bugbee-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@bugbee-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@bugbee-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
