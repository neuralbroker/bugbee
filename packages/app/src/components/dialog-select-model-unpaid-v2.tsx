...
import { Icon } from "@bugbee-ai/ui/v2/icon"
...
import { useTheme } from "@bugbee-ai/ui/theme"
...
const featuredProviders = ["bugbee", "bugbee-go", "openai", "anthropic", "google", "github-copilot"]
...
export const DialogSelectModelUnpaidV2: Component<{ model?: ModelState }> = (props) => {
  ...
  const isFree = (item: ReturnType<ModelState["list"]>[number]) =>
    item.provider.id === "bugbee" && (!item.cost || item.cost.input === 0)
