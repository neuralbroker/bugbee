...
const GLOBAL_STORAGE = "bugbee.global.dat"
const WINDOW_STORAGE = "bugbee.window"
const LOCAL_PREFIX = "bugbee."
...
function workspaceStorage(dir: string) {
  ...
  return `bugbee.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `bugbee.draft.${head}.${sum}.dat`
}
