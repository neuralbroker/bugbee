...
export const loadMcpQuery = (scope: ServerScope, directory: string, sdk: BugbeeClient) =>
  queryOptions({
    queryKey: [scope, directory, "mcp"] as const,
    queryFn: () => sdk.mcp.status().then((r) => r.data ?? {}),
  })

export const loadMcpResourcesQuery = (scope: ServerScope, directory: string, sdk: BugbeeClient) =>
...
export const loadLspQuery = (scope: ServerScope, directory: string, sdk: BugbeeClient) =>
  queryOptions({
...
function makeQueryOptionsApi(
  ...
  sdkFor: (dir: PathKey) => BugbeeClient,
) {
  return {
...
export function createServerSyncContextInner(serverSDK: ServerSDK) {
  ...
  const sdkCache = new Map<string, BugbeeClient>()
