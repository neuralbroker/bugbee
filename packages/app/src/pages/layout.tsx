...
import { Session } from "@bugbee-ai/sdk/v2/client"
...
import { toaster } from "@bugbee-ai/ui/toast"
...
import { retry } from "@bugbee-ai/core/util/retry"
...
import { useTheme, type ColorScheme } from "@bugbee-ai/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://bugbee.dev/desktop-feedback")}
      renderPanel={() =>
