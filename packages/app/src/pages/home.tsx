...
import { Logo } from "@bugbee-ai/ui/logo"
import { Spinner } from "@bugbee-ai/ui/spinner"
import { ScrollView } from "@bugbee-ai/ui/scroll-view"
import { ProjectAvatar } from "@bugbee-ai/ui/v2/project-avatar-v2"
...
import { base64Encode } from "@bugbee-ai/core/util/encode"
...
import { useMarked } from "@bugbee-ai/ui/context/marked"
import { preloadMarkdown } from "@bugbee-ai/session-ui/markdown-cache"
      ...
      >
        <div class="mx-auto grid min-h-full w-full max-w-[1080px] grid-rows-[auto_minmax(0,1fr)_auto] gap-4 px-3 lg:grid-cols-[280px_minmax(0,720px)] lg:grid-rows-1 lg:gap-8 lg:px-6">
          <HomeProjectColumn
            ...
            openHelp={() => platform.openLink("https://bugbee.dev/desktop-feedback")}
            language={language}
            onWheel={(event) => {
