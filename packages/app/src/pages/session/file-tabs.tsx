...
import type { FileSearchHandle } from "@bugbee-ai/session-ui/file"
import { useFileComponent } from "@bugbee-ai/ui/context/file"
import { cloneSelectedLineRange, previewSelectedLines } from "@bugbee-ai/session-ui/pierre/selection-bridge"
import { createLineCommentController } from "@bugbee-ai/session-ui/line-comment-annotations"
import { createLineCommentControllerV2 } from "@bugbee-ai/session-ui/v2/line-comment-annotations-v2"
import { sampledChecksum } from "@bugbee-ai/core/util/encode"
import { normalize, text } from "@bugbee-ai/session-ui/session-diff"
import { DropdownMenu } from "@bugbee-ai/ui/dropdown-menu"
import { IconButton } from "@bugbee-ai/ui/icon-button"
import { LineCommentV2OverflowIcon } from "@bugbee-ai/ui/v2/line-comment-v2"
  ...
  const renderFile = (source: string) => (
    <div class="relative overflow-hidden pb-40">
      <Dynamic
        ...
        search={search}
        class="select-text [--bugbee-diffs-bg:var(--v2-background-bg-base)]"
        media={{
          mode: "auto",
          path: path(),
