...
import {
  ...
  type StatsHomeData,
  type StatsLabData,
} from "@bugbee-ai/stats-core/domain/home"
...
export default function StatsLab() {
  ...
  return (
    <main data-page="stats" data-theme={themePreference()}>
      ...
      <Meta property="og:site_name" content="Bugbee" />
  ...
  return (
    ...
    >
      <div data-slot="lab-model-tooltip-summary">
        ...
        <p>{props.state.model.description ?? "Recent Bugbee Go usage, share, context, and output limits."}</p>
      </div>
      <div data-slot="tooltip-divider" />
