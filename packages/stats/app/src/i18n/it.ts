export const dict = {
  "app.title": "Classifiche di utilizzo dei modelli IA | Bugbee Data",
  "app.description":
    "Esplora l'utilizzo di Bugbee Go nei modelli IA, inclusi volume di token, classifiche, quota di mercato, prezzi dei token, costo per sessione, rapporto cache e ripartizioni geografiche.",
  "app.unfurlAlt": "Logotipo Bugbee Data su uno sfondo scuro con motivo",
  ...
  "header.githubAria": "Aggiungi una stella a Bugbee su GitHub",
  "header.github": "GitHub",
  "header.tryBugbee": "Prova Bugbee",
  ...
  "home.topModelsDescription": "Utilizzo dei modelli in Bugbee Go.",
  ...
  "home.uniqueUsersDescription": "Utenti unici giornalieri di Bugbee Go per modello.",
  ...
  "lab.title": "Utilizzo e classifiche dei modelli IA {{lab}} | Bugbee Data",
  "lab.description":
    "Confronta i modelli {{lab}} usati in Bugbee Go, inclusi utilizzo dei token, classifiche dei modelli, finestre di contesto, date di rilascio, costi e dati specifici del modello.",
  "lab.loadingTitle": "Laboratorio modelli",
  "lab.loadingDescription": "Lettura della disponibilità dei modelli e dell'utilizzo recente di Bugbee.",
  "lab.notFound": "Nessun modello corrispondeva a questo laboratorio.",
  "lab.heroPrefix": "Esplora {{count}} modelli {{lab}} usati in Bugbee",
  ...
  "lab.shareOfUsage": "{{share}} dell'utilizzo recente di Bugbee",
  "lab.usageTitle": "Utilizzo token {{lab}}",
  "lab.usageDescription": "Volume giornaliero di token Bugbee negli ultimi due mesi.",
  ...
  "lab.usage": "Utilizzo",
  "lab.share": "Quota",
  "model.title": "Utilizzo, costo e posizione di {{model}} | Bugbee Data",
  "model.description":
    "Visualizza i dati di utilizzo di {{model}} in Bugbee Go, inclusi volume di token, rango settimanale, mix di token, costi, rapporto cache, sessioni, ripartizioni geografiche e modelli simili.",
  ...
  "model.catalogFallback":
    "Fatti del modello dall'indice condiviso dei modelli. L'utilizzo di Bugbee Go appare quando questo modello ha attività.",
  "model.unranked": "Non classificato nell'utilizzo Bugbee Go della scorsa settimana",
  "model.ranked": "Posizione #{{rank}} nell'utilizzo Bugbee Go della scorsa settimana",
  ...
  "model.noCurrentUsage": "Nessun utilizzo di Bugbee Go nella finestra dati attuale.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Token recenti di Bugbee Go, utenti unici e posizione di mercato.",
  "model.noSummaryTitle": "Nessun riepilogo di utilizzo",
  "model.noSummaryDescription": "Questo modello non ha ancora righe di utilizzo di Bugbee Go.",
  "model.tokens": "Token",
  ...
  "model.usageDescription": "Volume giornaliero di token Bugbee Go nella recente finestra di due mesi.",
  ...
  "model.usersDescription": "Utenti unici giornalieri di Bugbee Go nella recente finestra di due mesi.",
  ...
  "model.efficiencyDescription": "Costi, comportamento della cache e forma media della sessione Bugbee Go.",
  ...
  "model.geoDescription": "Token del modello Bugbee Go usati per paese.",
  "model.noGeoTitle": "Nessun dato geografico",
  "model.noGeoDescription": "Nessuna riga geografica Bugbee Go corrispondeva a questo modello.",
  "model.worldMap": "Mappa mondiale dell'utilizzo dei token del modello per paese",
  "model.peersDescription": "Modelli vicini per volume recente di token Bugbee Go.",
