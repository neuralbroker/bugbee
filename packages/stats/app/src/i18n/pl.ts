export const dict = {
  "app.title": "Rankingi użycia modeli AI | Bugbee Data",
  "app.description":
    "Przeglądaj użycie Bugbee Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny Bugbee Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę Bugbee na GitHub",
  "header.github": "GitHub",
  "header.tryBugbee": "Wypróbuj Bugbee",
  ...
  "footer.homeAria": "Strona główna Bugbee",
  ...
  "home.topModelsDescription": "Użycie modeli w Bugbee Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy Bugbee Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | Bugbee Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w Bugbee Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia Bugbee.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w Bugbee",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia Bugbee",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów Bugbee z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | Bugbee Data",
  "model.description":
    "Zobacz dane użycia {{model}} w Bugbee Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie Bugbee Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu Bugbee Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu Bugbee Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia Bugbee Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny Bugbee Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia Bugbee Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów Bugbee Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy Bugbee Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji Bugbee Go.",
  ...
  "model.geoDescription": "Tokeny modelu Bugbee Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne Bugbee Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów Bugbee Go.",
