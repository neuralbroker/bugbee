export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | Bugbee Data",
  "app.description":
    "Bugbee Go kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde Bugbee Data logosu",
  ...
  "header.githubAria": "GitHub'da Bugbee'a yıldız ver",
  "header.github": "GitHub",
  "header.tryBugbee": "Bugbee'u dene",
  ...
  "footer.homeAria": "Bugbee ana sayfası",
  ...
  "home.topModelsDescription": "Bugbee Go genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz Bugbee Go kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | Bugbee Data",
  "lab.description":
    "Bugbee Go'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son Bugbee kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "Bugbee'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son Bugbee kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük Bugbee token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | Bugbee Data",
  "model.description":
    "{{model}} için Bugbee Go kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda Bugbee Go kullanımı görünür.",
  "model.unranked": "Geçen haftaki Bugbee Go kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki Bugbee Go kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde Bugbee Go kullanımı yok.",
  ...
  "model.overviewDescription": "Son Bugbee Go tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz Bugbee Go kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük Bugbee Go token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz Bugbee Go kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama Bugbee Go oturum yapısı.",
  ...
  "model.geoDescription": "Ülkeye göre kullanılan Bugbee Go model tokenları.",
  "model.noGeoTitle": "Coğrafi veri yok",
  "model.noGeoDescription": "Bu modelle eşleşen Bugbee Go coğrafi satırı yok.",
  "model.worldMap": "Ülkeye göre model token kullanımının dünya haritası",
  "model.peersDescription": "Son Bugbee Go token hacmine göre yakındaki modeller.",
