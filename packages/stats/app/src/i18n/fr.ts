export const dict = {
  "app.title": "Classements d'utilisation des modèles d'IA | Bugbee Data",
  "app.description":
    "Explorez l'utilisation d'Bugbee Go par modèle d'IA, avec le volume de tokens, les classements, la part de marché, le prix des tokens, le coût par session, le taux de cache et les répartitions géographiques.",
  "app.unfurlAlt": "Logo textuel Bugbee Data sur un fond sombre à motif",
  ...
  "header.githubAria": "Ajouter une étoile à Bugbee sur GitHub",
  "header.github": "GitHub",
  "header.tryBugbee": "Essayer Bugbee",
  ...
  "footer.homeAria": "Accueil Bugbee",
  ...
  "home.topModelsDescription": "Utilisation des modèles dans Bugbee Go.",
  ...
  "home.uniqueUsersDescription": "Utilisateurs uniques quotidiens d'Bugbee Go par modèle.",
  ...
  "lab.title": "Utilisation et classements des modèles d'IA {{lab}} | Bugbee Data",
  "lab.description":
    "Comparez les modèles {{lab}} utilisés dans Bugbee Go, avec l'utilisation des tokens, les classements de modèles, les fenêtres de contexte, les dates de sortie, les coûts et les données propres aux modèles.",
  "lab.loadingTitle": "Laboratoire de modèles",
  "lab.loadingDescription": "Lecture de la disponibilité des modèles et de l'utilisation récente d'Bugbee.",
  "lab.notFound": "Aucun modèle ne correspondait à ce laboratoire.",
  "lab.heroPrefix": "Explorez {{count}} modèles {{lab}} utilisés dans Bugbee",
  ...
  "lab.shareOfUsage": "{{share}} de l'utilisation récente d'Bugbee",
  "lab.usageTitle": "Utilisation des tokens {{lab}}",
  "lab.usageDescription": "Volume quotidien de tokens Bugbee sur les deux derniers mois.",
  ...
  "lab.share": "Part",
  "model.title": "Utilisation, coût et rang de {{model}} | Bugbee Data",
  "model.description":
    "Consultez les données d'utilisation Bugbee Go de {{model}}, avec le volume de tokens, le rang hebdomadaire, la répartition des tokens, les coûts, le taux de cache, les sessions, les répartitions géographiques et les modèles proches.",
  ...
  "model.catalogFallback":
    "Faits du modèle issus de l'index partagé des modèles. L'utilisation Bugbee Go apparaîtra dès que ce modèle aura de l'activité.",
  "model.unranked": "Non classé dans l'utilisation Bugbee Go de la semaine dernière",
  "model.ranked": "Classé #{{rank}} dans l'utilisation Bugbee Go de la semaine dernière",
  ...
  "model.noCurrentUsage": "Aucune utilisation Bugbee Go dans la fenêtre de données actuelle.",
  ...
  "model.overviewDescription": "Tokens Bugbee Go récents, utilisateurs uniques et position sur le marché.",
  "model.noSummaryTitle": "Aucun résumé d'utilisation",
  "model.noSummaryDescription": "Ce modèle n'a pas encore de lignes d'utilisation Bugbee Go.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume quotidien de tokens Bugbee Go sur la fenêtre récente de deux mois.",
  ...
  "model.usersDescription": "Utilisateurs uniques quotidiens d'Bugbee Go sur la fenêtre récente de deux mois.",
  ...
  "model.efficiencyDescription": "Coût, comportement du cache et forme moyenne des sessions Bugbee Go.",
  ...
  "model.geoDescription": "Tokens du modèle Bugbee Go utilisés par pays.",
  "model.noGeoTitle": "Aucune donnée géographique",
  "model.noGeoDescription": "Aucune ligne géographique Bugbee Go ne correspondait à ce modèle.",
  "model.worldMap": "Carte mondiale de l'utilisation des tokens du modèle par pays",
  "model.peersDescription": "Modèles proches par volume récent de tokens Bugbee Go.",
