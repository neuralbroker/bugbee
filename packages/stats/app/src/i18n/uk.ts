export const dict = {
  "app.title": "Рейтинги використання моделей ШІ | Bugbee Data",
  "app.description":
    "Досліджуйте використання Bugbee Go серед моделей ШІ, зокрема обсяг токенів, рейтинги, частку ринку, ціни токенів, вартість сеансу, частку кешу та географічні розрізи.",
  "app.unfurlAlt": "Словесний знак Bugbee Data на темному візерунковому тлі",
  ...
  "header.githubAria": "Поставити зірку Bugbee на GitHub",
  "header.github": "GitHub",
  "header.tryBugbee": "Спробувати Bugbee",
  ...
  "footer.homeAria": "Головна Bugbee",
  ...
  "home.topModelsDescription": "Використання моделей в Bugbee Go.",
  ...
  "home.uniqueUsersDescription": "Щоденні унікальні користувачі Bugbee Go за моделлю.",
  ...
  "lab.title": "Використання та рейтинги моделей ШІ {{lab}} | Bugbee Data",
  "lab.description":
    "Порівняйте моделі {{lab}}, які використовуються в Bugbee Go, зокрема використання токенів, рейтинги моделей, контекстні вікна, дати релізів, вартість і дані конкретних моделей.",
  "lab.loadingTitle": "Лабораторія моделей",
  "lab.loadingDescription": "Читаємо доступність моделей і нещодавнє використання Bugbee.",
  "lab.notFound": "Жодна модель не відповідала цій лабораторії.",
  "lab.heroPrefix": "Досліджуйте {{count}} моделей {{lab}}, що використовуються в Bugbee",
  ...
  "lab.shareOfUsage": "{{share}} нещодавнього використання Bugbee",
  "lab.usageTitle": "Використання токенів {{lab}}",
  "lab.usageDescription": "Щоденний обсяг токенів Bugbee за останні два місяці.",
  ...
  "lab.share": "Частка",
  "model.title": "Використання, вартість і ранг {{model}} | Bugbee Data",
  "model.description":
    "Перегляньте дані використання {{model}} в Bugbee Go, зокрема обсяг токенів, тижневий ранг, мікс токенів, вартість, частку кешу, сеанси, географічні розрізи та схожі моделі.",
  ...
  "model.catalogFallback":
    "Факти моделі зі спільного індексу моделей. Використання Bugbee Go з'явиться, коли ця модель матиме активність.",
  "model.unranked": "Без рейтингу у використанні Bugbee Go за минулий тиждень",
  "model.ranked": "Ранг #{{rank}} у використанні Bugbee Go за минулий тиждень",
  ...
  "model.noCurrentUsage": "Немає використання Bugbee Go в поточному вікні даних.",
  ...
  "model.release": "Реліз",
  "model.inputs": "Входи",
  "model.overviewDescription": "Нещодавні токени Bugbee Go, унікальні користувачі та ринкова позиція.",
  "model.noSummaryTitle": "Немає підсумку використання",
  "model.noSummaryDescription": "Ця модель ще не має рядків використання Bugbee Go.",
  "model.tokens": "Токени",
  ...
  "model.usageDescription": "Щоденний обсяг токенів Bugbee Go за нещодавнє двомісячне вікно.",
  ...
  "model.usersDescription": "Щоденні унікальні користувачі Bugbee Go за нещодавнє двомісячне вікно.",
  ...
  "model.efficiencyDescription": "Вартість, поведінка кешу та середня форма сеансу Bugbee Go.",
  ...
  "model.geoDescription": "Токени моделі Bugbee Go, використані за країнами.",
  "model.noGeoTitle": "Немає геоданих",
  "model.noGeoDescription": "Жодні географічні рядки Bugbee Go не відповідали цій моделі.",
  "model.worldMap": "Карта світу використання токенів моделі за країнами",
  "model.peersDescription": "Близькі моделі за нещодавнім обсягом токенів Bugbee Go.",
