export const dict = {
  "app.title": "Ranking de uso de modelos de IA | Bugbee Data",
  "app.description":
    "Explore o uso do Bugbee Go em modelos de IA, incluindo volume de tokens, rankings, participação de mercado, preço por token, custo por sessão, taxa de cache e distribuição geográfica.",
  "app.unfurlAlt": "Logotipo do Bugbee Data sobre um fundo escuro padronizado",
  ...
  "header.githubAria": "Dar estrela ao Bugbee no GitHub",
  "header.github": "GitHub",
  "header.tryBugbee": "Experimente o Bugbee",
  ...
  "footer.homeAria": "Início do Bugbee",
  ...
  "modal.title": "Newsletter do Bugbee",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos no Bugbee Go.",
  ...
  "home.uniqueUsersDescription": "Usuários únicos diários do Bugbee Go por modelo.",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | Bugbee Data",
  "lab.description":
    "Compare modelos da {{lab}} usados no Bugbee Go, incluindo uso de tokens, ranking de modelos, janelas de contexto, datas de lançamento, custos e dados específicos de cada modelo.",
  "lab.loadingTitle": "Laboratório de modelos",
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do Bugbee.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no Bugbee",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do Bugbee",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do Bugbee nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | Bugbee Data",
  "model.description":
    "Veja dados de uso de {{model}} no Bugbee Go, incluindo volume de tokens, ranking semanal, combinação de tokens, custos, taxa de cache, sessões, distribuição geográfica e modelos pares.",
  ...
  "model.catalogFallback":
    "Fatos do modelo do índice compartilhado de modelos. O uso no Bugbee Go aparece quando este modelo tiver atividade.",
  "model.unranked": "Sem classificação no uso do Bugbee Go da última semana",
  "model.ranked": "Classificado em #{{rank}} no uso do Bugbee Go da última semana",
  ...
  "model.noCurrentUsage": "Sem uso do Bugbee Go na janela de dados atual.",
  ...
  "model.overviewDescription": "Tokens recentes do Bugbee Go, usuários únicos e posição de mercado.",
  "model.noSummaryTitle": "Sem resumo de uso",
  "model.noSummaryDescription": "Este modelo ainda não tem linhas de uso do Bugbee Go.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume diário de tokens do Bugbee Go na janela recente de dois meses.",
  ...
  "model.usersDescription": "Usuários únicos diários do Bugbee Go na janela recente de dois meses.",
  ...
  "model.efficiencyDescription": "Custo, comportamento de cache e formato médio da sessão do Bugbee Go.",
  ...
  "model.geoDescription": "Tokens do modelo Bugbee Go usados por país.",
  "model.noGeoTitle": "Sem dados geográficos",
  "model.noGeoDescription": "Nenhuma linha geográfica do Bugbee Go correspondeu a este modelo.",
  "model.worldMap": "Mapa-múndi do uso de tokens do modelo por país",
  "model.peersDescription": "Modelos próximos por volume recente de tokens do Bugbee Go.",
