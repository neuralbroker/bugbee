export const dict = {
  "app.title": "Clasificaciones de uso de modelos de IA | Bugbee Data",
  "app.description":
    "Explora el uso de Bugbee Go en modelos de IA, incluido el volumen de tokens, clasificaciones, cuota de mercado, precios de tokens, coste por sesión, ratio de caché y desgloses geográficos.",
  "app.unfurlAlt": "Logotipo textual de Bugbee Data sobre un fondo oscuro con patrón",
  ...
  "header.githubAria": "Dale una estrella a Bugbee en GitHub",
  "header.github": "GitHub",
  "header.tryBugbee": "Probar Bugbee",
  ...
  "footer.homeAria": "Inicio de Bugbee",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos en Bugbee Go.",
  ...
  "home.uniqueUsersDescription": "Usuarios únicos diarios de Bugbee Go por modelo.",
  ...
  "lab.title": "Uso y clasificaciones de modelos de IA de {{lab}} | Bugbee Data",
  "lab.description":
    "Compara modelos de {{lab}} usados en Bugbee Go, incluido uso de tokens, clasificaciones de modelos, ventanas de contexto, fechas de lanzamiento, costes y datos específicos del modelo.",
  "lab.loadingTitle": "Laboratorio de modelos",
  "lab.loadingDescription": "Leyendo disponibilidad de modelos y uso reciente de Bugbee.",
  "lab.notFound": "Ningún modelo coincidió con este laboratorio.",
  "lab.heroPrefix": "Explora {{count}} modelos de {{lab}} usados en Bugbee",
  ...
  "lab.shareOfUsage": "{{share}} del uso reciente de Bugbee",
  "lab.usageTitle": "Uso de tokens de {{lab}}",
  "lab.usageDescription": "Volumen diario de tokens de Bugbee durante los últimos dos meses.",
  ...
  "lab.usage": "Uso",
  "lab.share": "Cuota",
  "model.title": "Uso, coste y posición de {{model}} | Bugbee Data",
  "model.description":
    "Consulta datos de uso de {{model}} en Bugbee Go, incluido volumen de tokens, posición semanal, mezcla de tokens, costes, ratio de caché, sesiones, desgloses geográficos y modelos similares.",
  ...
  "model.catalogFallback":
    "Datos del modelo desde el índice compartido de modelos. El uso de Bugbee Go aparecerá cuando este modelo tenga actividad.",
  "model.unranked": "Sin clasificación en el uso de Bugbee Go de la semana pasada",
  "model.ranked": "Clasificado #{{rank}} en el uso de Bugbee Go de la semana pasada",
  ...
  "model.noCurrentUsage": "Sin uso de Bugbee Go en la ventana de datos actual.",
  ...
  "model.overviewDescription": "Tokens recientes de Bugbee Go, usuarios únicos y posición de mercado.",
  "model.noSummaryTitle": "Sin resumen de uso",
  "model.noSummaryDescription": "Este modelo aún no tiene filas de uso de Bugbee Go.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volumen diario de tokens de Bugbee Go durante la ventana reciente de dos meses.",
  ...
  "model.usersDescription": "Usuarios únicos diarios de Bugbee Go durante la ventana reciente de dos meses.",
  ...
  "model.efficiencyDescription": "Coste, comportamiento de caché y forma media de sesión de Bugbee Go.",
  ...
  "model.geoDescription": "Tokens del modelo de Bugbee Go usados por país.",
  "model.noGeoTitle": "Sin datos geográficos",
  "model.noGeoDescription": "Ninguna fila geográfica de Bugbee Go coincidió con este modelo.",
  "model.worldMap": "Mapa mundial del uso de tokens del modelo por país",
  "model.peersDescription": "Modelos cercanos por volumen reciente de tokens de Bugbee Go.",
