...
const en = {
  "app.title": "AI Model Usage Rankings | Bugbee Data",
  "app.description":
    "Explore Bugbee Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "Bugbee Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star Bugbee on GitHub",
  "header.github": "GitHub",
  "header.tryBugbee": "Try Bugbee",
  ...
  "home.topModelsDescription": "Usage of models across Bugbee Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique Bugbee Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | Bugbee Data",
  "lab.description":
    "Compare {{lab}} models used in Bugbee Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent Bugbee usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in Bugbee",
  ...
  "lab.shareOfUsage": "{{share}} of recent Bugbee usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | Bugbee Data",
  "model.description":
    "View {{model}} Bugbee Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. Bugbee Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's Bugbee Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's Bugbee Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No Bugbee Go usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no Bugbee Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.geoDescription": "Bugbee Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No Bugbee Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent Bugbee Go token volume.",
