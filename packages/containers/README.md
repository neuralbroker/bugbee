...
```
REGISTRY=ghcr.io/neuralbroker TAG=24.04 bun ./packages/containers/script/build.ts
REGISTRY=ghcr.io/neuralbroker TAG=24.04 bun ./packages/containers/script/build.ts --push
```
...
jobs:
  build-cli:
    ...
    container:
      image: ghcr.io/neuralbroker/build/bun-node:24.04
```
