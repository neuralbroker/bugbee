...
export default new Hono<{ Bindings: Env }>()
  ...
  .post("/exchange_github_app_token", async (c) => {
    const EXPECTED_AUDIENCE = "bugbee-github-action"
  ...
  /**
   * Used by the GitHub action to get GitHub installation access token given user PAT token (used when testing `bugbee github run` locally)
   */
  ...
  /**
   * Used by the bugbee CLI to check if the GitHub app is installed
   */
