# Bugbee V2 Promise Plugin API

The Promise plugin API is the async/await equivalent of `@bugbee-ai/plugin/v2/effect`. It grants plugins the same two in-process capabilities:
...
```ts
import { define } from "@bugbee-ai/plugin/v2/promise"
