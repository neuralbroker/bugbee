...
- Effect plugins import `@bugbee-ai/plugin/v2/effect`, not `@bugbee-ai/core`.
- Public domain values use generated `@bugbee-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@bugbee-ai/plugin/v2/effect`.
