...
declare const BUGBEE_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof BUGBEE_CLI_NAME === "string" ? BUGBEE_CLI_NAME : "bugbee", {
  description: "Bugbee 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
