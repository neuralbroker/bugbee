...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new BugbeeClient()" to fix this error.`)
    }
    return instance
  }
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the Bugbee system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the Bugbee system.
   */
...
export class Capabilities extends HeyApiClient {
   ...
   *
   * Get experimental features enabled on the Bugbee server.
   */
...
export class Console extends HeyApiClient {
   ...
   *
   * Persist a new active Console account/org selection for the current local Bugbee state.
   */
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global Bugbee configuration settings and preferences.
   */
   ...
   *
   * Update global Bugbee configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the Bugbee server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the Bugbee system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all Bugbee instances, releasing all resources.
   */
   ...
   * Upgrade bugbee
   *
   * Upgrade bugbee to the specified version or latest if not specified.
   */
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current Bugbee configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update Bugbee configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current Bugbee instance, releasing all resources.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the Bugbee system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with Bugbee.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get current project
   *
   * Retrieve the currently active project that Bugbee is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by Bugbee.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all Bugbee sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new Bugbee session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific Bugbee session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class Session3 extends HeyApiClient {
   ...
   *
   * Interrupt active execution owned by this Bugbee process. Idle interruption is a no-op.
   */
...
export class BugbeeClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<BugbeeClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    BugbeeClient.__registry.set(this, args?.key)
  }
