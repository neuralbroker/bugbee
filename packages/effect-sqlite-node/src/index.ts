...
export const TypeId: TypeId = "~@bugbee-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@bugbee-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@bugbee-ai/effect-sqlite-node/NodeSqliteClient")
