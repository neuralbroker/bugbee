...
brew install neuralbroker/tap/bugbee # macOS og Linux (anbefalet, altid up to date)
brew install bugbee              # macOS og Linux (officiel brew formula, opdateres sjældnere)
...
Bugbee findes også som desktop-app. Download direkte fra [releases-siden](https://github.com/neuralbroker/bugbee/releases) eller [bugbee.dev/download](https://github.com/neuralbroker/bugbee/download).
...
1. `$BUGBEE_INSTALL_DIR` - Tilpasset installationsmappe
...
Bugbee har to indbyggede agents, som du kan skifte mellem med `Tab`-tasten.
...
Læs mere om [agents](https://github.com/neuralbroker/bugbee/docs/agents).

### Dokumentation

For mere info om konfiguration af Bugbee, [**se vores docs**](https://github.com/neuralbroker/bugbee/docs).

### Bidrag

Hvis du vil bidrage til Bugbee, så læs vores [contributing docs](./CONTRIBUTING.md) før du sender en pull request.

### Bygget på Bugbee

Hvis du arbejder på et projekt der er relateret til Bugbee og bruger "bugbee" som en del af navnet; f.eks. "bugbee-dashboard" eller "bugbee-mobile", så tilføj en note i din README, der tydeliggør at projektet ikke er bygget af Bugbee-teamet og ikke er tilknyttet os på nogen måde.

---

**Bliv en del af vores community** [Discord](https://discord.gg/bugbee) | [X.com](https://x.com/bugbee)
