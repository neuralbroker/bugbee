...
- PR #10809: https://github.com/neuralbroker/bugbee/pull/10809
- PR #11496: https://github.com/neuralbroker/bugbee/pull/11496

## Do Not Translate (Locale Additions)

- `Bugbee` (preserve casing in prose; keep `bugbee` only in commands, package names, paths, or code)
- `Bugbee CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
