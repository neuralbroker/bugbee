...
- PR #13942: https://github.com/neuralbroker/bugbee/pull/13942

## Do Not Translate (Locale Additions)

- `Bugbee` (preserve casing in prose; keep `bugbee` only when it is part of commands, package names, paths, or code)
- `Bugbee Zen`
- `Bugbee CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `bugbee` in prose when referring to the product name; use `Bugbee`
