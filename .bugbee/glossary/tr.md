...
- PR #15835: https://github.com/neuralbroker/bugbee/pull/15835

## Do Not Translate (Locale Additions)

- `Bugbee` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `bugbee` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Bugbee` in prose, `bugbee` only for exact technical identifiers
...
- Avoid changing `bugbee` to `Bugbee` inside commands, URLs, package names, or code literals
