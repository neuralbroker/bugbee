...
Use this folder for locale-specific translation guidance that supplements `.bugbee/agent/translator.md`.
...
- PR #12345: https://github.com/neuralbroker/bugbee/pull/12345

## Do Not Translate (Locale Additions)

- `Bugbee` (preserve casing)
