...
Desktop application and browser-based app issues, including `bugbee web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core bugbee server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

Bugbee Zen, Bugbee Go, and billing issues.
